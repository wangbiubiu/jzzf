<?php /* Smarty version 2.6.18, created on 2016-01-07 09:52:08
         compiled from D:%5Cvirtualhost%5Cxxzckj%5CCashier%5C./pigcms_tpl/Merchants/System/merchant/addbanner.tpl.php */ ?>
<!DOCTYPE html>
<html>
<head>
...
<link href="<?php echo @PIGCMS_TPL_STATIC_PATH; ?>
wxCoupon/card_control.css" rel="stylesheet">
<link href="<?php echo @PIGCMS_TPL_STATIC_PATH; ?>
wxCoupon/section_card_notification.css" rel="stylesheet">
<link href="<?php echo @RlStaticResource; ?>
...
" />
				                                <div class="form-group">
				                                    ...
				                                    <div class="col-sm-2"><input type="text" class="form-control" name="title" id="title" value="<?php echo $this->_tpl_vars['banner']['title']; ?>
" /></div>
				                                </div>
				                                <div class="hr-line-dashed"></div>
				                                ...
				                                <div class="form-group">
													...
													<div class="col-sm-4">
													<input type="text" class="form-control externalLink" name="url" id="url" value="<?php echo $this->_tpl_vars['banner']['url']; ?>
"> 
...
"> 
												...
												<div class="form-group"> 
													...
													<input type="hidden" id="js_pic_url" name="pic" value="<?php echo $this->_tpl_vars['banner']['pic']; ?>
"/> 
													<div class="col-sm-2">
														<img src="<?php echo $this->_tpl_vars['banner']['pic']; ?>
" id="js_pic_preview" <?php if (! empty ( $this->_tpl_vars['banner']['pic'] )): ?>style="height: 100px; width:200px;"<?php endif; ?>/>
													</div>
												</div>
				                                <div class="hr-line-dashed"></div>
				                                ...
				                                <div class="form-group">
				                                    ...
				                                    <div class="col-sm-1"><input type="text" class="form-control" name="sort" id="sort" value="<?php echo $this->_tpl_vars['banner']['sort']; ?>
" /></div>
