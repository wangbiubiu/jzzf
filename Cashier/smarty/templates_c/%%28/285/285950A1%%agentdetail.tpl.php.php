<?php /* Smarty version 2.6.18, created on 2017-10-27 11:36:10
         compiled from C:%5CUsers%5CAdministrator%5CDesktop%5Clll%5CCashier%5C./pigcms_tpl/Merchants/System/count/agentdetail.tpl.php */ ?>
<!DOCTYPE html>
<html>
    <head>
                                    ...
                                    <div class="clearfix" style="height:240px; position: relative;">
                                        <table border="1" class="payment" style="margin: 30px 30px 30px 0px; " width="60%" bordercolor="#e0e0e0">
                                            <tbody>
                                                ...
                                                <?php elseif ($this->_tpl_vars['getdata']['type'] == 'qq'): ?>
                                                <tr>
                                                    <td>qq</td>
                                                    <td><?php echo $this->_tpl_vars['qqsum']; ?>
</td>
                                                    <td><?php echo $this->_tpl_vars['qqcome_sum']; ?>
</td>
                                                </tr>
                                                <?php else: ?>
                                                    <tr>
