<?php /* Smarty version 2.6.18, created on 2017-10-27 10:20:54
         compiled from C:%5CUsers%5CAdministrator%5CDesktop%5Clll%5CCashier%5C./pigcms_tpl/Merchants/System/settlement/abank.tpl.php */ ?>
<!DOCTYPE html>
<html>
                            ...
                            <form action="/merchants.php?m=System&c=settlement&a=abank" method="get">
                                ...
                                <div id="dataselect" class="form-group" style="padding: 0 10px;">
                                    <div id="datepicker" class="input-daterange">
                                        ...
                                        <input class="input form-control" type="text"  name="aid" <?php if (( isset ( $this->_tpl_vars['data']['aid'] ) )): ?><?php echo $this->_tpl_vars['data']['aid']; ?>
<?php endif; ?> placeholder="输入代理商编号" style="width: 17%;border-radius:3px;height: 30px; margin-bottom: 0px;">
...
?>
                                    <tr class="widget-list-item bd_nr" style="text-align: center;height:50px;">
                                        <td><?php echo $this->_tpl_vars['vv']['uname']; ?>
</td>
                                        ...
                                        <td>
                                            <button class="btn btn-sm btn-info" onclick="window.open('/merchants.php?m=System&c=settlement&a=card&id=<?php echo $this->_tpl_vars['vv']['id']; ?>
')" style="background: #44b549;">查看证件</button>
