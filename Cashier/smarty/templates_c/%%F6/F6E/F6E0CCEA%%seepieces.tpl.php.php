<?php /* Smarty version 2.6.18, created on 2017-10-27 15:33:36
         compiled from C:%5CUsers%5CAdministrator%5CDesktop%5Clll%5CCashier%5C./pigcms_tpl/Merchants/System/merchant/seepieces.tpl.php */ ?>
<!DOCTYPE html>
<html>
<head>
    <title>进件查看</title>
...
至<?php echo $this->_tpl_vars['regist']['idend']; ?>
                ...
                <div class="select_permissions ">
                    ...
                    <p><label>支付授权目录：</label><span><?php echo $this->_tpl_vars['regist']['wechat']['authPaydir']; ?>
</span></p>
                    <p><label>微信渠道号：</label><span><?php echo $this->_tpl_vars['regist']['wechat']['weiXinChannelId']; ?>
</span></p>
