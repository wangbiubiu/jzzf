<?php /* Smarty version 2.6.18, created on 2016-11-16 15:24:02
         compiled from D:%5Ctest%5Cpay%5Cpay%5CCashier%5C./pigcms_tpl/Merchants/System/author/addm.tpl.php */ ?>
<!DOCTYPE html>
<html>
...
plugins/css/iCheck/custom.css" rel="stylesheet">
	...
	.jbxi_bg>div{border-top: 1px solid #f2f2f2; padding: 10px 0; margin: 0px !important;float: left; width: 100%;}
                    	...
                    	<div class="ibox-content" style="border-top:none;">
                    		  ...
                    		  <div class="panel-body" style="padding: 0px; ">
                                <form class="form-horizontal form-border jbxi_bg clearfix" style="width: 95%; margin: 0 auto 60px; position: relative; border: 1px solid #EEEEEE;">
                                    <p style="text-align: left; background: #f2f2f2; height: 40px; line-height: 40px; margin-bottom: 0px; padding-left: 20px;">员工添加</p>
                                    ...
                                    <div class="form-group clearfix">
                                    	...
                                    	<div>
                                    		<input type="text" placeholder="输入您的密码" style="height: 30px; width: 150px; margin-left: 10px; border: none;">
                                    	</div>
                                     ...
                                     <div class="form-group clearfix">
                                    	...
                                    	<div>
                                    		<input type="password" placeholder="请重新输入您的密码" style="height: 30px; width: 150px; margin-left: 10px; border: none;">
                                    	</div>
