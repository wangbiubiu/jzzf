<?php /* Smarty version 2.6.18, created on 2017-10-31 10:20:02
         compiled from C:%5CUsers%5CAdministrator%5CDesktop%5Clll%5CCashier%5C./pigcms_tpl/Merchants/System/settlement/cashapply.tpl.php */ ?>
<!DOCTYPE html>
<html>
...
?>
                                                <tr class="widget-list-item bd_nr" style="text-align: center;">
                                                    ...
                                                    <td>
                                                        <?php if (( $this->_tpl_vars['vv']['bank_name'] == 'ICBC' )): ?>工商银行<?php endif; ?>
                                                        <?php if (( $this->_tpl_vars['vv']['bank_name'] == 'ABC' )): ?>农业银行<?php endif; ?>
                                                        <?php if (( $this->_tpl_vars['vv']['bank_name'] == 'BOC' )): ?>中国银行<?php endif; ?>
                                                        <?php if (( $this->_tpl_vars['vv']['bank_name'] == 'CCB' )): ?>建设银行<?php endif; ?>
                                                        <?php if (( $this->_tpl_vars['vv']['bank_name'] == 'CMB' )): ?>招商银行<?php endif; ?>
                                                        <?php if (( $this->_tpl_vars['vv']['bank_name'] == 'BOCM' )): ?>交通银行<?php endif; ?>
                                                        <?php if (( $this->_tpl_vars['vv']['bank_name'] == 'CMBC' )): ?>民生银行<?php endif; ?>
                                                        <?php if (( $this->_tpl_vars['vv']['bank_name'] == 'CNCB' )): ?>中信银行<?php endif; ?>
                                                        <?php if (( $this->_tpl_vars['vv']['bank_name'] == 'CEBB' )): ?>光大银行<?php endif; ?>
                                                        <?php if (( $this->_tpl_vars['vv']['bank_name'] == 'CIB' )): ?>兴业银行<?php endif; ?>
                                                        <?php if (( $this->_tpl_vars['vv']['bank_name'] == 'BOB' )): ?>北京银行<?php endif; ?>
                                                        <?php if (( $this->_tpl_vars['vv']['bank_name'] == 'GDB' )): ?>广发银行<?php endif; ?>
                                                        <?php if (( $this->_tpl_vars['vv']['bank_name'] == 'HXB' )): ?>华夏银行<?php endif; ?>
                                                        <?php if (( $this->_tpl_vars['vv']['bank_name'] == 'PAB' )): ?>平安银行<?php endif; ?>
                                                        <?php if (( $this->_tpl_vars['vv']['bank_name'] == 'BOS' )): ?>上海银行<?php endif; ?>
                                                        <?php if (( $this->_tpl_vars['vv']['bank_name'] == 'BOHC' )): ?>渤海银行<?php endif; ?>
                                                        <?php if (( $this->_tpl_vars['vv']['bank_name'] == 'BOJ' )): ?>江苏银行<?php endif; ?>
                                                        <?php if (( $this->_tpl_vars['vv']['bank_name'] == 'SPDB' )): ?>浦发银行<?php endif; ?>
                                                        <?php if (( $this->_tpl_vars['vv']['bank_name'] == 'PSBC' )): ?>邮储银行<?php endif; ?>
                                                        <?php if (( $this->_tpl_vars['vv']['bank_name'] == "" )): ?>其他银行<?php endif; ?>
                                                    </td>
...
"  style="background: #008fd3;">处理提现</button>-->
                                                            <button class="btn btn-sm btn-info deal" data-id="<?php echo $this->_tpl_vars['v']['id']; ?>
"  style="background: #008fd3;">处理提现</button>
                                                            <?php endif; ?>
                                                        </p>
                                                    </td>
