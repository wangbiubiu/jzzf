<?php /* Smarty version 2.6.18, created on 2017-06-16 15:51:10
         compiled from /www/html/pay.yunjifu.net/Cashier/./pigcms_tpl/Merchants/System/settlement/mset.tpl.php */ ?>
<!DOCTYPE html>
<html>
...
<?php endif; ?>" name="end" class="input-sm form-control" id="dateend" placeholder="结束时间" style=" margin-bottom: 0px; width: 17%;height: 30px;border-radius:3px"> 
                                            ...
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="btn btn-primary"  style="width:100px;" href="?m=System&c=settlement&a=data2Excel&type=mch" >导出excel</a>

                                            <a class="btn btn-primary"  style="width:100px;" href="/merchants.php?m=Index&c=auto&a=index" target="_blank">一键代付</a>
