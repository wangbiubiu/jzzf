<?php /* Smarty version 2.6.18, created on 2017-07-26 11:33:59
         compiled from D:%5CWWW%5Cpay.yunjifu.net%5CCashier%5C./pigcms_tpl/Merchants/System/settlement/cashlist.tpl.php */ ?>
<!DOCTYPE html>
<html>
                            ...
                            <form action="/merchants.php?m=System&c=settlement&a=cashlist" method="get">
                                ...
                                <div id="dataselect" class="form-group" style="padding: 0 10px;">
                                    <div id="datepicker" class="input-daterange">
                                        ...
                                        <input class="input form-control" type="text" name="txt" value="<?php if (( isset ( $this->_tpl_vars['data']['txt'] ) )): ?><?php echo $this->_tpl_vars['data']['txt']; ?>
<?php endif; ?>" placeholder="输入开户姓名/银行卡号/手机号码" style="width: 17%;border-radius:3px;height: 30px; margin-bottom: 0px;">
...
<?php endif; ?>" name="start" class="input-sm form-control" id="start" placeholder="开始时间" style=" margin-bottom: 0px; width: 17%;border-radius:3px;height: 30px">
                                        &nbsp;<span> 到 </span>&nbsp;
                                        <input type="text" value="<?php if (( isset ( $this->_tpl_vars['data']['end'] ) )): ?><?php echo $this->_tpl_vars['data']['end']; ?>
<?php endif; ?>" name="end" class="input-sm form-control" id="end" placeholder="结束时间" style=" margin-bottom: 0px; width: 17%;border-radius:3px;height: 30px">
...
?>
                                    <tr class="widget-list-item bd_nr" style="text-align: center;">
                                        <td><?php echo $this->_tpl_vars['vv']['orderNo']; ?>
</td>
                                        <td>
                                            ...
                                            <?php if (( $this->_tpl_vars['vv']['settBankNo'] == "" )): ?>其他银行<?php endif; ?>
                                        </td>
                                        ...
                                        <td><?php echo $this->_tpl_vars['vv']['time']; ?>
</td>
                                        <td><?php echo $this->_tpl_vars['vv']['transAmt']; ?>
</td>
                                        <td><?php if (( $this->_tpl_vars['vv']['state'] == '0' )): ?>提现中<?php else: ?>提现成功<?php endif; ?></td>
                                    </tr>
