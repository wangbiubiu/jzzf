<?php /* Smarty version 2.6.18, created on 2017-10-27 10:20:04
         compiled from C:%5CUsers%5CAdministrator%5CDesktop%5Clll%5CCashier%5C./pigcms_tpl/Merchants/System/merchant/merLists.tpl.php */ ?>
<!DOCTYPE html>
<html>
    <head>
...
?>
                                                                ...
                                                                <tr class="widget-list-item">
                                                                    ...
                                                                    <td>
                                                                        <?php if ($this->_tpl_vars['v']['sub_merchant'] == 1 || $this->_tpl_vars['v']['mtype'] == 1): ?>
...
&type=2">
                                                                            ...
                                                                            <?php endif; ?>
                                                                            <?php elseif ($this->_tpl_vars['v']['mtype'] == 2): ?>
                                                                            银行直连
                                                                        <?php elseif ($this->_tpl_vars['v']['mtype'] == 3): ?>
                                                                        金海哲
                                                                        <?php elseif ($this->_tpl_vars['v']['sub_merchant'] == 1): ?>
                                                                        子商户
                                                                        <?php endif; ?>
