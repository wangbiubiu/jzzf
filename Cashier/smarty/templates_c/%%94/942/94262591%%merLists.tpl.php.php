<?php /* Smarty version 2.6.18, created on 2016-12-26 12:38:25
         compiled from /phpstudy/www/pay.yunjifu.net/Cashier/./pigcms_tpl/Merchants/System/merchant/merLists.tpl.php */ ?>
<!DOCTYPE html>
<html>
    <head>
...
&type=2">
                                                                        ...
                                                                        <?php endif; ?>
                                                                        <?php else: ?>
                                                                        <a class="btn btn-primary"  onclick="lookBanck(<?php echo $this->_tpl_vars['v']['mid']; ?>
)">查看信息</a>
                                                                        <?php endif; ?>
                                                                    </td>
                                                                    <td>
