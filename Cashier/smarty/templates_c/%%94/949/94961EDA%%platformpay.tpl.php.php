<?php /* Smarty version 2.6.18, created on 2016-09-20 13:50:40
         compiled from C:%5CphpStudy%5CWWW%5Cxitong%5Cpay%5CCashier%5C./pigcms_tpl/Merchants/System/pfpay/platformpay.tpl.php */ ?>
<!DOCTYPE html>
<html>
<head>
...
?>
									  <tr>
									    <td class="selecttd">
										<?php if ($this->_tpl_vars['merOderInfo'][$this->_sections['vv']['index']]['state'] != 2): ?>
										<input type="checkbox" class="i-checks" value="<?php echo $this->_tpl_vars['merOderInfo'][$this->_sections['vv']['index']]['id']; ?>
">
										<?php else: ?>
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<?php endif; ?>&nbsp;
										<?php echo $this->_tpl_vars['merOderInfo'][$this->_sections['vv']['index']]['id']; ?>
									   ...
									   <td><?php echo $this->_tpl_vars['merOderInfo'][$this->_sections['vv']['index']]['statestr']; ?>
<?php if ($this->_tpl_vars['merOderInfo'][$this->_sections['vv']['index']]['state'] != 2): ?>&nbsp;&nbsp;&nbsp;<a class="btn btn-primary dzbtn" onclick="checkOrder(<?php echo $this->_tpl_vars['merOderInfo'][$this->_sections['vv']['index']]['id']; ?>
,this);">点击对账</a><?php endif; ?></td>
									  </tr>
									 <?php endfor; endif; ?>
