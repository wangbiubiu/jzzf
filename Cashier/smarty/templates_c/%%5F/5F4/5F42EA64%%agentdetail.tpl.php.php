<?php /* Smarty version 2.6.18, created on 2016-12-29 19:14:25
         compiled from /phpstudy/www/pay.yunjifu.net/Cashier/./pigcms_tpl/Merchants/System/count/agentdetail.tpl.php */ ?>
<!DOCTYPE html>
<html>
    <head>
                            ...
                            <div class="ibox float-e-margins">
                                <div class="ibox-title">
                                    <div class="form-group" style="border-bottom: 1px solid #cccccc; font-size: 18px;">
                                        <label class="font-noraml"><?php echo $this->_tpl_vars['name']['uname']; ?>
的流水统计</label>
            ...
            描述：选择日期
                                    -->     
                                    <form action="/merchants.php?m=System&c=count&a=agentdetail" method="get">
                                        <input type="hidden" value="System" name="m" >
                                        <input type="hidden" value="count" name="c" >
                                        <input type="hidden" value="agentdetail" name="a" >
                                        <div id="dataselect" class="form-group" style="padding: 0 10px;">
                                            ...
                                            <div id="datepicker" class="input-daterange">
                                                ...
                                                <input type="text" <?php if (( isset ( $this->_tpl_vars['getdata']['start'] ) )): ?> value="<?php echo $this->_tpl_vars['getdata']['start']; ?>
"  <?php endif; ?> name="start" class="input-sm form-control" id="datestart" placeholder="开始时间" style=" margin-bottom: 0px; width: 15%; height:30px">
                                                &nbsp;<span> 到 </span>&nbsp; 
                                                <input type="text" <?php if (( isset ( $this->_tpl_vars['getdata']['end'] ) )): ?> value="<?php echo $this->_tpl_vars['getdata']['end']; ?>
                                    ...
                                    <div class="clearfix" style="height:240px; position: relative;">
                                        <table border="1" class="payment" style="margin: 30px 30px 30px 0px; " width="60%" bordercolor="#e0e0e0">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>微信支付</td>
                                                    <td><?php echo $this->_tpl_vars['wxsum']; ?>
</td>
                                                    <td><?php echo $this->_tpl_vars['wxincome_sum']; ?>
</td>
                                                </tr>
                                                <?php elseif ($this->_tpl_vars['getdata']['type'] == 'alipay'): ?>
                                                <tr>
                                                    <td>支付宝城市</td>
                                                    <td><?php echo $this->_tpl_vars['alisum']; ?>
</td>
                                                    <td><?php echo $this->_tpl_vars['alicome_sum']; ?>
</td>
                                                </tr>
                                                <?php else: ?>
                                                    <tr>
...
止<?php else: ?>全部<?php endif; ?></td>
                                                        <td><?php echo $this->_tpl_vars['total_sum']; ?>
</td>
                                                        <td><?php echo $this->_tpl_vars['totalincome_sum']; ?>
</td>
                                                    </tr>
                                                    <tr>
                                                        <td>微信支付</td>
...
<?php endif; ?></td>
                                                            ...
                                                            <td><?php echo $this->_tpl_vars['row']['company']; ?>
+<?php echo $this->_tpl_vars['row']['business_name']; ?>
...
<?php else: ?><?php echo $this->_tpl_vars['wxsum']; ?>
<?php endif; ?>,
                color: "#33EA90",
            highlight: "#4BFFA8",
                label: "微信支付"
...
<?php else: ?><?php echo $this->_tpl_vars['alisum']; ?>
<?php endif; ?>,
                color: "#00a3d2",
            highlight: "#24c7f6",
                label: "支付宝"
