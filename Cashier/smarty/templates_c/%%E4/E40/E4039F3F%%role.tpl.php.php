<?php /* Smarty version 2.6.18, created on 2016-11-16 15:23:32
         compiled from D:%5Ctest%5Cpay%5Cpay%5CCashier%5C./pigcms_tpl/Merchants/System/author/role.tpl.php */ ?>
<!DOCTYPE html>
<html>
<head>
<title>角色列表</title>
					...
					<div class="col-lg-12">
						<div class="ibox float-e-margins">
							<div class="ibox-title clearfix">
								<ul class="nav">
									<li>
										 <a  class="sh btn btn-primary" id="pop_add_shop" href="/merchants.php?m=System&c=author&a=addrole"><i class="fa fa-plus"></i> 添加角色</a>
									</li>
								</ul>
							</div>
