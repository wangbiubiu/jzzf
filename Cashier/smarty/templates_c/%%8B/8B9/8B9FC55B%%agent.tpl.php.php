<?php /* Smarty version 2.6.18, created on 2016-12-23 20:55:33
         compiled from /phpstudy/www/pay.yunjifu.net/Cashier/./pigcms_tpl/Merchants/System/count/agent.tpl.php */ ?>
<!DOCTYPE html>
<html>
    <head>
                                ...
                                <form action="/merchants.php?m=System&c=count&a=agent" method="get">
                                    ...
                                    <div id="dataselect" class="form-group" style="padding: 0 10px;">
                                        <div id="datepicker" class="input-daterange">
                                            ...
                                            <input type="text" value="<?php if (isset($getdata['start'])) echo $getdata['start']; ?>"  name="start" class="input-sm form-control" id="datestart" placeholder="开始时间" style=" margin-bottom: 0px; width: 20%; height: 30px;">
                                            &nbsp;<span> 到 </span>&nbsp; 
                                            <input type="text" value="<?php if (isset($getdata['end'])) echo $getdata['end']; ?>" name="end" class="input-sm form-control" id="dateend" placeholder="结束时间" style=" margin-bottom: 0px; width: 20%;height: 30px;"> 
