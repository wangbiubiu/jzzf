<?php /* Smarty version 2.6.18, created on 2017-10-28 12:00:34
         compiled from C:%5CUsers%5CAdministrator%5CDesktop%5Clll%5CCashier%5C./pigcms_tpl/Merchants/System/settlement/medit.tpl.php */ ?>
<!DOCTYPE html>
<html>
<head>
    <title>补单处理</title>
 ...
 ?>
        ...
        <div class="wrapper wrapper-content animated fadeInRight" >
            <div class="row payment_allocation">
                <h1>结算处理 </h1>
                <div>
                    <form action="merchants.php?m=System&c=settlement&a=settx" method="post">
                        <input type="hidden" value="<?php echo $this->_tpl_vars['bank']['id']; ?>
" name="id"/>
                        <h2>记录冲正</h2>
                        <div>
                            <label>商户ID</label>
                            <input type="text" id="or"  placeholder="" value="<?php echo $this->_tpl_vars['bank']['mid']; ?>
" readonly="readonly"/>
                        </div>
                        <div>
                            <label>商户名称</label>
                            <input type="text" id="or"  placeholder="" value="<?php echo $this->_tpl_vars['bank']['username']; ?>
" readonly="readonly"/>
                        </div>
                        <div>
                            <label>收款金额</label>
                            <input type="text" id="or"  placeholder="" value="<?php echo $this->_tpl_vars['bank']['money2']; ?>
" readonly="readonly"/>
                        </div>
                        <div>
                            <label>提现金额</label>
                            <input type="text" id="or"  placeholder="" value="<?php echo $this->_tpl_vars['bank']['money']; ?>
" name="money"/>
