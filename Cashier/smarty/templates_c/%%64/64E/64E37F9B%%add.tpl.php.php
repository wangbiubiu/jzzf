<?php /* Smarty version 2.6.18, created on 2016-12-26 11:35:31
         compiled from /phpstudy/www/pay.yunjifu.net/Cashier/./pigcms_tpl/Merchants/System/agent/add.tpl.php */ ?>
...
"><?php echo $this->_tpl_vars['avv']['fullname']; ?>
                                    ...
                                    <div class="form-group clearfix">
                                        <label class="control-label"><i>*</i>佣金率</label>
                                        <div>
                                          <input type="text" class="form-control" name="commission" placeholder="请输入佣金返点">%  <span style="color: red; display: none;"></span>
                                        </div>
                                    </div>
<!--                                    <div class="form-group clearfix">
