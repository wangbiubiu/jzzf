<?php /* Smarty version 2.6.18, created on 2016-12-19 17:44:03
         compiled from D:%5Ctest%5Cpay%5Cpay%5CCashier%5C./pigcms_tpl/Merchants/System/qrcode/TemplateImage.tpl.php */ ?>
<!DOCTYPE html>
<html>
<head>
									   ...
									   <div class="img_upload_wrp group"> 
											...
											<div class="js_pager">
											     <div class="img_upload_box img_upload_preview_box js_edit_pic_wrp">
											         <img  src="<?php echo $this->_tpl_vars['pay_img_url']; ?>
">
								...
								<div style="float: left;">
									...
									<div id="js_upload_wrp">
									   <div class="img_upload_wrp group"> 
											...
											<div class="js_pager">
											     <div class="img_upload_box img_upload_preview_box js_edit_pic_wrp">
											         <img  src="<?php echo $this->_tpl_vars['notice_img_url']; ?>
">
											             <input name="photo_list[]" class="imginput" type="hidden" value="'+rept.wxlogurl+'">
...
">
							...
							<div style="float: right; margin-right:20px;width:550px;">
								    ...
								    <img alt="" src="<?php echo $this->_tpl_vars['url']; ?>
/Cashier/upload/img/notice_test.jpg">
							</div>
					</div>
        		</form>
