<?php /* Smarty version 2.6.18, created on 2017-08-24 12:00:56
         compiled from D:%5CWWW%5Cpay.yunjifu.net%5CCashier%5C./pigcms_tpl/Merchants/System/agent/edit.tpl.php */ ?>
...
" class="form-control" placeholder="公司名称">
                                          ...
                                          <div class="form-group clearfix">
                                              ...
                                              <div>
                                                  ...
                                                  <b >银行直连:</b>  <input type="checkbox" id="mtypes"  value="2" name="mtype[]" <?php echo  $this->_tpl_vars['row']['mtype']==3 || $this->_tpl_vars['row']['mtype']==2?'checked':''?> style="margin-top: 10px">
                                              </div>
                                          </div>
