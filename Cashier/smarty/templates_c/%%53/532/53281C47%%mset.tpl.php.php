<?php /* Smarty version 2.6.18, created on 2016-12-23 20:59:58
         compiled from /phpstudy/www/pay.yunjifu.net/Cashier/./pigcms_tpl/Merchants/System/settlement/mset.tpl.php */ ?>
<!DOCTYPE html>
<html>
...
<?php endif; ?>" name="end" class="input-sm form-control" id="dateend" placeholder="结束时间" style=" margin-bottom: 0px; width: 17%;height: 30px;border-radius:3px"> 
                                            &nbsp;&nbsp;&nbsp;<input class="btn btn-primary" type="submit" value="查 询" style="width:70px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="btn btn-primary"  style="width:100px;" href="?m=System&c=settlement&a=data2Excel&type=mch" >导出excel</a>
                                        </div>
                                    </div>
                                 </form>
...
<?php endif; ?>" name="end" class="input-sm form-control" id="dateend" placeholder="结束时间" style=" margin-bottom: 0px; width: 17%;border-radius:3px;height: 30px"> 
                                            &nbsp;&nbsp;&nbsp;<input class="btn btn-primary" type="submit" value="查 询" style="width:70px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="btn btn-primary"  style="width:100px;" href="?m=System&c=settlement&a=data2Excel&type=mchb" >导出excel</a>
                                        </div>
                                    </div>
                                   </form>
                                    <div class="employersDelAll" >
    ...
    <script>
         $('.debit').click(function () {
            ...
            swal({
                ...
                if (isConfirm) {
                    $.ajax({
                        url: "?m=System&c=settlement&a=setmdebit",
                        type: "POST",
                        data: {'id': id},
                        dataType: "JSON",
