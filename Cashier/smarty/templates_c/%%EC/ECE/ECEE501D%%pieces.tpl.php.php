<?php /* Smarty version 2.6.18, created on 2017-10-27 10:20:08
         compiled from C:%5CUsers%5CAdministrator%5CDesktop%5Clll%5CCashier%5C./pigcms_tpl/Merchants/System/merchant/pieces.tpl.php */ ?>
<!DOCTYPE html>
<html>
<head>
...
?>
															<tr class="widget-list-item">
                                                                ...
                                                                <td>
                                                                    <?php if (( $this->_tpl_vars['v']['mtype'] == 2 )): ?>
                                                                    <?php if (( ! empty ( $this->_tpl_vars['v']['alipay'] ) )): ?>
                                                                    <p>支付宝</p>
                                                                    <?php endif; ?>
                                                                    <?php if (( ! empty ( $this->_tpl_vars['v']['wechat'] ) )): ?>
                                                                    <p>微信</p>
                                                                    <?php endif; ?>
                                                                    <?php else: ?>
                                                                    <p>微信</p>
                                                                ...
                                                                <td>
                                                                    <?php if (( $this->_tpl_vars['v']['mtype'] == 1 )): ?>
                                                                    <!--默认状态start-->
                                                                    ...
                                                                    <?php if (( ! empty ( $this->_tpl_vars['v']['alipay'] ) )): ?>
                                                                    <!--支付宝状态start-->
                                                                    <?php if (( $this->_tpl_vars['v']['alipaystatus'] == 0 )): ?>
                                                                    <p>待初审</p>
                                                                    <?php elseif (( $this->_tpl_vars['v']['alipaystatus'] == 1 )): ?>
                                                                    <p>初审成功并审核中</p>
                                                                    <?php elseif (( $this->_tpl_vars['v']['alipaystatus'] == 2 )): ?>
                                                                    <p>审核成功</p>
                                                                    <?php elseif (( $this->_tpl_vars['v']['alipaystatus'] == 3 )): ?>
                                                                    <p>审核失败</p>
                                                                    <?php elseif (( $this->_tpl_vars['v']['alipaystatus'] == 4 )): ?>
                                                                    <p>初审失败</p>
                                                                    <?php endif; ?>
                                                                    <!--支付宝状态end-->
                                                                    <?php endif; ?>
                                                                    <?php if (( ! empty ( $this->_tpl_vars['v']['wechat'] ) )): ?>
                                                                    <!--微信状态start-->
                                                                    <?php if (( $this->_tpl_vars['v']['wechatstatus'] == 0 )): ?>
                                                                    <p>待初审</p>
                                                                    <?php elseif (( $this->_tpl_vars['v']['wechatstatus'] == 1 )): ?>
                                                                    <p>初审成功并审核中</p>
                                                                    <?php elseif (( $this->_tpl_vars['v']['wechatstatus'] == 2 )): ?>
                                                                    <p>审核成功</p>
                                                                    <?php elseif (( $this->_tpl_vars['v']['wechatstatus'] == 3 )): ?>
                                                                    <p>审核失败</p>
                                                                    <?php elseif (( $this->_tpl_vars['v']['wechatstatus'] == 4 )): ?>
                                                                    <p>初审失败</p>
                                                                    <?php endif; ?>
                                                                    <!--微信状态end-->
                                                                    <?php endif; ?>
...
"><strong>删&nbsp;&nbsp;除 </strong></button>
                                                                    ...
                                                                    <?php if (( ! empty ( $this->_tpl_vars['v']['alipay'] ) )): ?>
                                                                    <p>
                                                                        <a href="?m=System&c=merchant&a=seepieces&id=<?php echo $this->_tpl_vars['v']['alipay']; ?>
"><button class="jinjian" style="color:#ffffff">查看进件</button></a>
                                                                    <button class="btn btn-sm btn-danger delete" data-id="<?php echo $this->_tpl_vars['v']['alipay']; ?>
"><strong>删&nbsp;&nbsp;除 </strong></button>
                                                                    </p>
                                                                    <?php endif; ?>
                                                                    <?php if (( ! empty ( $this->_tpl_vars['v']['wechat'] ) )): ?>
                                                                    <p>
                                                                    <a href="?m=System&c=merchant&a=seepieces&id=<?php echo $this->_tpl_vars['v']['wechat']; ?>
"><button class="jinjian" style="color:#ffffff">查看进件</button></a>
                                                                    <button class="btn btn-sm btn-danger delete" data-id="<?php echo $this->_tpl_vars['v']['wechat']; ?>
"><strong>删&nbsp;&nbsp;除 </strong></button>
                                                                    </p>
                                                                    <?php endif; ?>
                                                                    <?php endif; ?>
