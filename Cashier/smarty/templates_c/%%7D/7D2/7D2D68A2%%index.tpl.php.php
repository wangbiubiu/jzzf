<?php /* Smarty version 2.6.18, created on 2017-08-24 11:47:21
         compiled from D:%5CWWW%5Cpay.yunjifu.net%5CCashier%5C./pigcms_tpl/Merchants/System/agent/index.tpl.php */ ?>
<!DOCTYPE html>
<html>
    <head>
...
?>
                                                                ...
                                                                <tr class="widget-list-item">
                                                                    ...
                                                                    <td class="bor" style="padding-top: 20px">
                                                                        <p style="padding-bottom: 2.5px">特约商户</p>
                                                                        <p style="padding-top: 2.5px">银行直连</p>
                                                                    </td>
                                                                  <td class="bor" style="padding-top: 20px">
                                                                      <p style="padding-bottom: 2.5px"><?php echo $this->_tpl_vars['v']['commission']*100; ?>
%</p>
                                                                      <p style="padding-top: 2.5px"><?php echo $this->_tpl_vars['v']['alicommission']*100; ?>
%</p>
                                                                  </td>
                                                                <!--                                                                    <td><?php echo $this->_tpl_vars['v']['alicommission']*100; ?>
%</td>-->
                                                                  <td class="bor" style="padding-top: 20px">
                                                                      <p style="padding-bottom: 2.5px"><?php echo $this->_tpl_vars['v']['ancommission']*100; ?>
%</p>
                                                                      <p style="padding-top: 2.5px"><?php echo $this->_tpl_vars['v']['analicommission']*100; ?>
%</p>
                                                                  </td>
