<?php /* Smarty version 2.6.18, created on 2017-10-27 12:52:29
         compiled from C:%5CUsers%5CAdministrator%5CDesktop%5Clll%5CCashier%5C./pigcms_tpl/Merchants/System/count/merchant.tpl.php */ ?>
<!DOCTYPE html>
<html>
    <head>
                                    ...
                                    <div id="dataselect" class="form-group" style="padding: 0 10px;">
                                        ...
                                        <div id="datepicker" class="input-daterange">
                                            ...
                                            <select name="mtype" style=" width: 120px; height: 30px; margin-bottom: 0px">
                                                ...
                                                <option value="2" <?php if ($this->_tpl_vars['getdata']['mtype'] == 2): ?>selected="selected"<?php endif; ?>>银行间连</option>
                                                <option value="3" <?php if ($this->_tpl_vars['getdata']['mtype'] == 3): ?>selected="selected"<?php endif; ?>>金海哲</option>
                                            </select>
...
?>
                                            <tr>
                                                ...
                                                <?php if ($this->_tpl_vars['v']['mtype'] == 3): ?>
                                                    <td>
                                                        <p>微信</p>
                                                        <p>qq</p>
                                                    </td>
...
<?php else: ?>0<?php endif; ?></p>
                                                        <p><?php if (! empty ( $this->_tpl_vars['v']['qqsum']['0']['money'] )): ?><?php echo $this->_tpl_vars['v']['qqsum']['0']['money']; ?>
<?php else: ?>0<?php endif; ?></p>
                                                    </td>
                                                    <td>
                                                        <p><?php echo $this->_tpl_vars['v']['wxsum']['0']['count']; ?>
</p>
                                                        <p><?php echo $this->_tpl_vars['v']['qqsum']['0']['count']; ?>
</p>
                                                    </td>
                                                    <td>
                                                        <p><?php echo $this->_tpl_vars['v']['commission']*100; ?>
%</p>
                                                        <p><?php echo $this->_tpl_vars['v']['qqcommission']*100; ?>
%</p>
                                                    </td>
                                                    <td>
                                                        <p><?php if (! empty ( $this->_tpl_vars['v']['wxsum']['0']['income'] )): ?><?php echo $this->_tpl_vars['v']['wxsum']['0']['income']; ?>
<?php else: ?>0<?php endif; ?></p>
                                                        <p><?php if (! empty ( $this->_tpl_vars['v']['qqsum']['0']['income'] )): ?><?php echo $this->_tpl_vars['v']['qqsum']['0']['income']; ?>
<?php else: ?>0<?php endif; ?></p>
                                                    </td>
                                                <?php else: ?>
                                                    <td>
