<?php /* Smarty version 2.6.18, created on 2017-10-28 10:44:19
         compiled from C:%5CUsers%5CAdministrator%5CDesktop%5Clll%5CCashier%5C./pigcms_tpl/Merchants/System/settlement/adebit.tpl.php */ ?>
<!DOCTYPE html>
<html>
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content " style="border-top:none">
                            <form action="/merchants.php?m=System&c=settlement&a=adebit" method="get">
                                <input type="hidden" value="System" name="m" >
                                <input type="hidden" value="settlement" name="c" >
                                <input type="hidden" value="adebit" name="a" >
                            ...
                            <div class="employersDelAll" >
                                <table class="footable table table-stripped toggle-arrow-tiny" data-page-size="10" data-filter=#filter style="margin-bottom: 0px;">
                                    ...
                                    <tr>
                                        ...
                                        <th style="text-align: center;" data-hide="phone">提现佣金</th>
                                    </tr>
                                    </thead>
...
?>
                                    <tr class="widget-list-item bd_nr" style="text-align: center;">
                                        ...
                                        <td><?php echo $this->_tpl_vars['vv']['count_turnover']; ?>
</td>
                                        <td><?php echo $this->_tpl_vars['vv']['count_deposit']; ?>
</td>
                                        <td>
                                            <p>
