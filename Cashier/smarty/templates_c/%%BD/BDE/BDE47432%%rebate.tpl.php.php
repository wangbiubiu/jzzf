<?php /* Smarty version 2.6.18, created on 2017-10-27 10:07:52
         compiled from C:%5CUsers%5CAdministrator%5CDesktop%5Clll%5CCashier%5C./pigcms_tpl/Merchants/System/pay/rebate.tpl.php */ ?>
...
unset($_smarty_tpl_vars);
 ...
 %</p>
                                  <h2>金海哲</h2>
                                  <p>微信当前值：<?php echo $this->_tpl_vars['row']['4']['rebate']; ?>
 %</p>
                                    <p>qq财付通当前值：<?php echo $this->_tpl_vars['row']['5']['rebate']; ?>
 %</p>
                                <div class="col-sm-12">
                                    <h2>官方特约商户</h2>
                                    <div class="form-group col-sm-6">
    									<label class="col-lg-5 control-label">新微信结算费率</label>
    									<div class="col-sm-7 input-group"><input type="text" class="form-control" placeholder="输入新的费率" name="aclear_wx_edit_rebate" style="width:70%" value="<?php echo $this->_tpl_vars['row']['0']['rebate']; ?>
"><span style="padding-top:10px; display: inline-block; margin-left: 10px">%</span></div>
                                   ...
                                   <div class="form-group col-sm-6">
                                        ...
                                        <div class="col-sm-7 input-group"><input type="text" class="form-control" placeholder="输入新的费率" name="aclear_ali_edit_rebate" style="width:70%" value="<?php echo $this->_tpl_vars['row']['1']['rebate']; ?>
"><span style="padding-top:10px; display: inline-block; margin-left: 10px">%</span></div>
                                   </div>
                                </div>
                                ...
                                <div  class="col-sm-12">
                                    ...
                                    <div class="form-group col-sm-6">
    									<label class="col-lg-5 control-label">新微信结算费率</label>
    									<div class="col-sm-7 input-group"><input type="text" class="form-control" placeholder="输入新的费率" name="an_wx_edit_rebate" style="width:70%" value="<?php echo $this->_tpl_vars['row']['2']['rebate']; ?>
" ><span style="padding-top:10px; display: inline-block; margin-left: 10px" >%</span></div>
                                   </div>
                                   <div class="form-group col-sm-6">
    									<label class="col-lg-5 control-label">新支付宝结算费率</label>
                                        <div class="col-sm-7 input-group"><input type="text" class="form-control" placeholder="输入新的费率" name="an_ali_edit_rebate" style="width:70%" value="<?php echo $this->_tpl_vars['row']['3']['rebate']; ?>
"><span style="padding-top:10px; display: inline-block; margin-left: 10px" >%</span></div>
                                   </div>
                                </div>
                                ...
                                <div  class="col-sm-12">
                                    ...
                                    <div class="form-group col-sm-6">
    									<label class="col-lg-5 control-label">新微信结算费率</label>
    									<div class="col-sm-7 input-group"><input type="text" class="form-control" placeholder="输入新的费率" name="jhz_wx_edit_rebate" style="width:70%" value="<?php echo $this->_tpl_vars['row']['4']['rebate']; ?>
" ><span style="padding-top:10px; display: inline-block; margin-left: 10px" >%</span></div>
                                   </div>
                                   <div class="form-group col-sm-6">
    									<label class="col-lg-5 control-label">qq财付通结算费率</label>
    									<div class="col-sm-7 input-group"><input type="text" class="form-control" placeholder="输入新的费率" name="jhz_qq_edit_rebate" style="width:70%" value="<?php echo $this->_tpl_vars['row']['5']['rebate']; ?>
" ><span style="padding-top:10px; display: inline-block; margin-left: 10px" >%</span></div>
                                   </div>
                                </div>
...
<!--                                    </div>-->
                                  ...
                                  <div class="col-sm-12">
                                    ...
                                    <div class="form-group col-sm-12">
    									<label class="col-lg-3 control-label">微信商家费率</label>
    									<div class="col-sm-9 input-group"><input type="text" class="form-control" placeholder="输入新的费率" name="an_jhz_wx_interest" style="width:70%" value="<?php echo $this->_tpl_vars['row_an']['4']['rebate']; ?>
"><span style="padding-top:10px; display: inline-block; margin-left: 10px">%</span></div>
                                   </div>
                                   <div class="form-group col-sm-12">
    									<label class="col-lg-3 control-label">财付通商家费率</label>
                                        <div class="col-sm-9 input-group"><input type="text" class="form-control" placeholder="输入新的费率" name="an_jhz_qq_interest" style="width:70%" value="<?php echo $this->_tpl_vars['row_an']['5']['rebate']; ?>
"><span style="padding-top:10px; display: inline-block; margin-left: 10px">%</span></div>
                                   </div>
                                </div>
                                <!--  
