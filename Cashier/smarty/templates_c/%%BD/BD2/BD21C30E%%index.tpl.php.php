<?php /* Smarty version 2.6.18, created on 2017-10-27 10:07:41
         compiled from C:%5CUsers%5CAdministrator%5CDesktop%5Clll%5CCashier%5C./pigcms_tpl/Merchants/System/index/index.tpl.php */ ?>
<!DOCTYPE html>
<html>
<head>
...
?>
                            <li class="clearfix" style=" position: relative">
                                <a  href="/merchants.php?m=System&c=index&a=notice&id=<?php echo $this->_tpl_vars['v']['id']; ?>
">
                                    <span><i>></i><?php echo $this->_tpl_vars['v']['title']; ?>
</span>
                                    <span style="height: 40px;line-height: 40px">[<?php echo $this->_tpl_vars['v']['addtime']; ?>
]</span>
                                </a><a href="#" data-id ="<?php echo $this->_tpl_vars['v']['id']; ?>
"  class="del" style=" position: absolute; right: 20px; top: 10px">删除</a>
                            </li>
