<?php /* Smarty version 2.6.18, created on 2017-09-08 12:06:47
         compiled from D:%5CWWW%5Cpay.yunjifu.net%5CCashier%5C./pigcms_tpl/Merchants/System/agent/add.tpl.php */ ?>
...
<!--                                          <i style="color: red ;padding-right: 10px">*</i><b>特约通道</b> <input type="radio"  name="mtype" value="1" id="tei">&ensp;&ensp;&ensp;<i style="color: red ;padding-right: 10px">*</i><b>银行通道</b><input type="radio"  name="mtype" id="yin" value="2" >-->
                                          <div>
                                              ...
                                              银行直连<input type="checkbox" value="2" id="mtype" name="mtype[]">
                                          </div>
