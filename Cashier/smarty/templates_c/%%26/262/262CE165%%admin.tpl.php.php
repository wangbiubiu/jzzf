<?php /* Smarty version 2.6.18, created on 2016-10-27 15:07:54
         compiled from D:%5Ctest%5Cpay%5Cpay%5CCashier%5C./pigcms_tpl/Merchants/System/jurisdiction/admin.tpl.php */ ?>
<!DOCTYPE html>
<html>
<head>
<title>代理商</title>
					...
					<div class="col-lg-12">
						<div class="ibox float-e-margins">
							<div class="ibox-title clearfix">
								<ul class="nav">
									<li>
										  <a  class="sh btn btn-primary" id="pop_add_shop" href="/merchants.php?m=System&c=jurisdiction&a=addm"><i class="fa fa-plus"></i> 添加管理员</a>
									</li>
								</ul>
							</div>
