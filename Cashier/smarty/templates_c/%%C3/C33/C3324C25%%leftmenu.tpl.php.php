<?php /* Smarty version 2.6.18, created on 2016-03-15 11:31:07
         compiled from D:%5Cvirtualhost%5Cxxzckj%5CCashier%5C./pigcms_tpl/Merchants/System/public/leftmenu.tpl.php */ ?>
            ...
            <ul id="side-menu" class="nav metismenu">
				...
				<li <?php if (in_array ( ROUTE_CONTROL , array ( 'pay' , 'merchant' , 'sysconf' ) )): ?> class="active" <?php endif; ?>>
                    ...
                    <ul class="nav nav-second-level collapse <?php if (in_array ( ROUTE_CONTROL , array ( 'pay' , 'merchant' , 'sysconf' ) )): ?> in <?php endif; ?>">
                        ...
                        <li <?php if (ROUTE_CONTROL == 'merchant' && ROUTE_ACTION == 'config'): ?> class="active" <?php endif; ?>><a href="/merchants.php?m=System&c=merchant&a=config">短信配置</a></li>
