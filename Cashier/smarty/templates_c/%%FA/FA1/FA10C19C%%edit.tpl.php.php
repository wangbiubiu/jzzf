<?php /* Smarty version 2.6.18, created on 2017-10-27 17:53:48
         compiled from C:%5CUsers%5CAdministrator%5CDesktop%5Clll%5CCashier%5C./pigcms_tpl/Merchants/System/agent/edit.tpl.php */ ?>
...
" class="form-control" placeholder="公司名称">
                                          ...
                                          <div class="form-group clearfix" id="tei">
                                              ...
                                              <div>
                                                  <!--                                           微信结算率 <input type="text" value="<?php echo $this->_tpl_vars['row']['commission']*100; ?>
" name="commission" class="form-control" placeholder="50%" style=" width: 10%;display:inline-block;"><span>%</span>-->
                                                  <!--                                            支付宝结算率 <input type="text" value="<?php echo $this->_tpl_vars['row']['commission']*100; ?>
" name="commission"  placeholder="50%" style=" width: 10%;display:inline-block;"><span>%</span>-->
                                                  <b>支付宝结算率:</b>
...
" <?php echo $this->_tpl_vars['teAli']/100==$this->_tpl_vars['row']['alicommission']?'selected':''?> ><?php echo $this->_tpl_vars['teAli']; ?>
%</option>
...
" <?php echo $this->_tpl_vars['teWx']/100==$this->_tpl_vars['row']['commission']?'selected':''?>><?php echo $this->_tpl_vars['teWx']; ?>
%</option>
                                                      <?php endforeach; endif; unset($_from); ?>
                                                  </select>
                                              </div>
                                          ...
                                          <div class="form-group clearfix" id="yin">
                                              ...
                                              <div>
                                                  ...
                                                  <select style="width: 150px;margin-top: 5px;" name="analicommission" >
                                                      ...
                                                      <?php $_from = $this->_tpl_vars['yinAli']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['yinAli']):
?>
                                                      <option value="<?php echo $this->_tpl_vars['yinAli']; ?>
" <?php echo $this->_tpl_vars['yinAli']/100==$this->_tpl_vars['row']['analicommission']?'selected':''?>><?php echo $this->_tpl_vars['yinAli']; ?>
%</option>
                                                      <?php endforeach; endif; unset($_from); ?>
                                                  </select>
                                                  &ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;
...
" <?php echo $this->_tpl_vars['yinWx']/100==$this->_tpl_vars['row']['ancommission']?'selected':''?> ><?php echo $this->_tpl_vars['yinWx']; ?>
%</option>
                                                      <?php endforeach; endif; unset($_from); ?>
                                                  </select>
                                              </div>
...
?>
                                                      <option value="<?php echo $this->_tpl_vars['jhzqq']; ?>
" <?php echo $this->_tpl_vars['jhzqq']/100==$this->_tpl_vars['row']['qqcommission']?'selected':''?>><?php echo $this->_tpl_vars['jhzqq']; ?>
%</option>
                                                      <?php endforeach; endif; unset($_from); ?>
                                                  </select>
                                                  &ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;
...
" <?php echo $this->_tpl_vars['jhzwx']/100==$this->_tpl_vars['row']['wxcommission']?'selected':''?> ><?php echo $this->_tpl_vars['jhzwx']; ?>
%</option>
                                                      <?php endforeach; endif; unset($_from); ?>
                                                  </select>
                                              </div>
