<?php /* Smarty version 2.6.18, created on 2017-10-27 10:13:37
         compiled from C:%5CUsers%5CAdministrator%5CDesktop%5Clll%5CCashier%5C./pigcms_tpl/Merchants/System/pay/config.tpl.php */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'urldecode', 'C:\\Users\\Administrator\\Desktop\\lll\\Cashier\\./pigcms_tpl/Merchants/System/pay/config.tpl.php', 133, false),)), $this); ?>
            	    ...
            	    <div class="ibox float-e-margins">
            	        ...
            	        <div class="ibox-content">
							<div class="alert alert-warning">
                               1、请配置一个有特约商户管理功能的商户号相关微信支付信息，不然代理功能不可用。
							  <strong style="color:red;">2、特别提醒：一旦配置好，请勿再改换配置。如果改换了配置，那么在原来的配置上所付款将不能退款，所发的卡券不能核销等等</strong>
                            </div>
...
" name="weixin[appSecret]" class="form-control">
							...
							<div class="form-group">
								<label>服务商商户号</label>
								<input type="text" placeholder="服务商商户号" value="<?php echo $this->_tpl_vars['payConfig']['weixin']['mchid']; ?>
" name="weixin[mchid]" class="form-control">
							</div>
                                                        <div class="form-group">
								<label>二清商户号</label>
								<input type="text" placeholder="二清商户号" value="<?php echo $this->_tpl_vars['payConfig']['weixin']['sub_mch_id_two']; ?>
" name="weixin[sub_mch_id_two]" class="form-control">
							</div>
							<div class="form-group">
								<label>特约子商户号(多个子商户号用英文逗号分隔)</label>
<!--								<input type="text" placeholder="如：1265536601,1265538835" class="form-control">-->
								<textarea name="weixin[sub_mchid]" placeholder="如：1265536601,1265538835"  class="form-control" rows="3"><?php echo ((is_array($_tmp=$this->_tpl_vars['payConfig']['weixin']['sub_mchid'])) ? $this->_run_mod_handler('urldecode', true, $_tmp) : urldecode($_tmp)); ?>
</textarea>
								&nbsp;<span>非必填，在设置特约商户时用到</span>
							</div>
							<div class="form-group">
								<label>API密钥</label>
...
&midtype=1" class="form-control" readonly="readonly">
							</div>
							<div class="form-group">
								<label>Token：</label>
				...
				<div class="modal-body">
					<div class="setting_rows">
						<div id="new_wxpay_box" class="wxpay_box">
							...
							<div class="form-group">
								<label>Appid</label>
								<input type="text" placeholder="支付宝Appid(必填)" value="<?php echo $this->_tpl_vars['payConfig']['alipay']['appid']; ?>
" name="alipay[appid]" class="form-control">
							</div>
							<div class="form-group">
								<label>PID</label>
								<input type="text" placeholder="合作者身份Partner id(必填)" value="<?php echo $this->_tpl_vars['payConfig']['alipay']['pid']; ?>
" name="alipay[pid]" class="form-control">
							</div>
                            <div class="form-group">
                                <label>Key</label>
                                <input type="text" placeholder="Key(选填)" value="<?php echo $this->_tpl_vars['payConfig']['alipay']['key']; ?>
" name="alipay[key]" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>二清商户号</label>
                                <input type="text" placeholder="二清商户号" value="<?php echo $this->_tpl_vars['payConfig']['alipay']['sub_mch_id_two']; ?>
" name="alipay[sub_mch_id_two]" class="form-control">
                            </div>
							<div class="form-group">
								<label>卖家账号</label>
								<input type="text" placeholder="卖家账号(选填)" value="<?php echo $this->_tpl_vars['payConfig']['alipay']['name']; ?>
" name="alipay[name]" class="form-control">
							</div>
						  <div class="form-group">
							<label>公钥（服务窗）&nbsp;&nbsp;&nbsp;复制这个公钥到支付宝需要上传的地方</label>
							<input type="text" placeholder="公钥（服务窗）" value="<?php echo $this->_tpl_vars['rsapublickey']; ?>
" class="form-control">
							</div>
						</div>
					</div>
