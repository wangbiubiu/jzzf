<?php /* Smarty version 2.6.18, created on 2017-08-25 11:01:21
         compiled from D:%5CWWW%5Cpay.yunjifu.net%5CCashier%5C./pigcms_tpl/Merchants/System/merchant/config.tpl.php */ ?>
<!DOCTYPE html>
<html>
<head>
                ...
                <div class="configure">
                    <form id="wxform" action="" method="post" enctype="multipart/form-data" data-mode='weixin'>
                        <div class="weixin">         <h2>微信支付配置
                                <?php if ($this->_tpl_vars['state1'] != '2'): ?>
...
">
                                <div><label>mchID：&nbsp;&nbsp;</label><input style="line-height: 24px" class="shh" type="text" name="weixin[mchid]" value="<?php echo $this->_tpl_vars['payConfig']['configData']['weixin']['mchid']; ?>
" placeholder="请输入商户号" onkeyup="this.value=this.value.replace(/\D/g,'')"/><span class="ts" style="color: red;display: none;">请填写商户号</span></div>
                                <div><label>商户名称：</label><input style="line-height: 24px" class="mc" type="text" name="weixin[nickname]" value="<?php echo $this->_tpl_vars['wxname']; ?>
" placeholder="请输入商户名称" /><span class="ts" style="color: red;display: none;">请填写商户名称</span></div>
                            </div>
                ...
                -->
                    <form style="display: none;" action="" name='ali' method="post" data-mode='alipay'>
                        <div class="zfb clearfix">
                            <h2>支付宝2.0收款参数配置
                                <?php if ($this->_tpl_vars['state2'] != '2'): ?>
                                <span>（收款通道暂未通过审核，审核通过方可保存）</span>
                                <?php else: ?>
...
" name='alipay[appID]' placeholder="请输入支付宝商户号" onkeyup="this.value=this.value.replace(/\D/g,'')"/>
                            ...
                            <div><label>商户名称：</label><input style="line-height: 24px" class="zfbmc" type="text" name="alipay[appNickname]" value="<?php echo $this->_tpl_vars['aliname']; ?>
" placeholder="请输入商户名称" /><span class="ts" style="color: red;display: none;">请填写商户名称</span></div>
