                    ...
                    <div class="ibox float-e-margins">
                    	...
                    	<div class="ibox-content" style="border-top:none;">
                    		  ...
                    		  <div class="panel-body" style="padding: 0px; ">
                                <form class="form-horizontal form-border jbxi_bg clearfix" style="width: 95%; margin: 0 auto 60px; position: relative; border: 1px solid #EEEEEE;" method="post" action=''>
                                   ...
                                   <!-- 
                                    ...
                                    <div class="form-group clearfix">
                                        ...
                                        <div>
                                           <input type="text"  class="form-control" value="<?php echo $saler['commission']*100; ?>" disabled>
                                        </div>
                                    </div>
<!--                                     <div class="form-group clearfix">
