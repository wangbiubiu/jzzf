...
<body>
	...
	<div class="ibox-title clearfix">
		<ul> 
			<li style="width: 150px;"><a  href="" class="btn btn-primary"> 会员卡消费记录 </a></li> 
			<li><a  href="/merchants.php?m=User&c=memberLoc&a=offExpense&cdid=<?php echo $cdid;?>&memberno=<?php echo $memberno;?>" class="btn btn-outline btn-primary"> 线下交易记录 </a></li> 
		</ul> 
   </div>
    ...
    <div>
      ...
      <div class="cashier-realtime"> 
       <div class="realtime-title-block clearfix"> 
        <h3 class="realtime-title">会员卡交易列表</h3> 
       </div> 
      </div> 
         ...
         <table class="ui-table ui-table-list" data-page-size="20" style="padding: 0px;"> 
          <thead class="js-list-header-region tableFloatingHeaderOriginal">
           <tr class="widget-list-header">
            ...
            <th data-hide="phone">交易状态</th>
			<th data-hide="phone">openID</th>
          ...
          <tbody class="js-list-body-region" id="table-list-body">
           ...
           <tr class="widget-list-item">
			...
			<td><?php echo date('Y-m-d H:i:s',$kvv['createtime']);?></td>
            <td><?php echo $kvv['orderdesc'];?></td> 
            <td><?php $opt='+';if($kvv['type']==1) $opt='-'; echo $opt.$kvv['price'];?></td> 

            <td><?php if($kvv['paid']==1){ echo '<font color="green">已支付</font>';}else{echo '<font color="red">未支付</font>';}?></td> 
			<td><?php echo $kvv['openid'];?></td>
            <td>
 ...
 $(document).ready(function(){
  ...
  function deltheItem(obj,piid){
	swal({
		...
		if (isConfirm) {
			$.ajax({
			url: "?m=User&c=memberLoc&a=delpayrecord&cdid=<?php echo $cdid;?>",
			type: "POST",
			dataType: "json",
			data:{piid:piid},
