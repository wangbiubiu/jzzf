                ...
                <div class="col-lg-12">
                    	...
                    	<div class="ibox-content yc" style="border-top:none;">
                    		  ...
                    		  <div class="panel-body" style="padding: 0px; ">
                                <div class="form-horizontal form-border jbxi_bg" style="width: 100%; margin: 0 auto; border: 1px solid #EEEEEE;">
                                	<h4 class="tit_h4"><span>基本信息</span><a style="float: right;" href="/merchants.php?m=User&c=merchant&a=information">编辑</a></h4>
                            ...
                            <table class="footable table table-stripped toggle-arrow-tiny" data-page-size="10" data-filter=#filter>
                                ...
                                <tbody class="js-list-body-region" id="table-list-body">
										...
										<tr class="widget-list-item bd_nr" style="text-align: center;">
												...
												<td>
													<p>
														<a href="/merchants.php?m=User&c=merchant&a=assistant"><button class="btn btn-sm btn-info" style="background: #337ab7;">管理</button></a>
														<button class="btn btn-sm btn-info" style="background: #44b549;">进入管理</button>
														<button class="btn btn-sm btn-danger delete" style="background: #ed5565;">删除</button>
													</p>
												</td>
									...
									<tr class="widget-list-item bd_nr" style="text-align: center;">
												...
												<td>
													<p>
                                                                                                            <a href=""><button class="btn btn-sm btn-info" style="background: #337ab7;">管理</button></a>
														<button class="btn btn-sm btn-info" style="background: #44b549;">进入管理</button>
														<button class="btn btn-sm btn-danger delete" style="background: #ed5565;">删除</button>
													</p>
												</td>
                    ...
                    <!--
                       ...
                       <div class="ibox-content yc" style="border-top:none">
                            <label>
                                                  店员名称
                           <form> <input type="text"  id="filter" placeholder="输入店员名称" style="width: 160px; height: 30px;"></form>
                            <button style=" background: #44b549; border: none; padding: 0 10px; border-radius: 5px; height: 30px; color: #FFFFFF;">搜索</button>
                            </label>
							<div class="employersDelAll" >
                    ...
                    <!--
                        ...
                        <div class="ibox-content yc" style="border-top:none;">
                    		  ...
                    		  <div class="panel-body" style="padding: 0px; ">
                                <div class="form-horizontal form-border jbxi_bg" style="width: 100%; margin: 0 auto; border: 1px solid #EEEEEE;">
                                	<h4 class="tit_h4"><span>打印机设置</span><a style="float: right;" href="/merchants.php?m=User&c=merchant&a=printerset">设置</a></h4>
                                    <div class="form-group clearfix">
                                        <label>打印机名称</label>
                                        <p>易优付c41</p>
                                    </div>
