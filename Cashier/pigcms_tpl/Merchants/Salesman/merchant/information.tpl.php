                    		  ...
                    		  <div class="panel-body" style="padding: 0px; ">
                                <form class="form-horizontal form-border jbxi_bg clearfix" style="width: 80%; margin: 0 auto 60px;position: relative; border: 1px solid #EEEEEE;">
                                    ...
                                    <div class="form-group clearfix">
                                        ...
                                        <div>
                                            <input type="text" class="form-control" placeholder="输入店名">
                                        </div>
                                    </div>
                                    <div class="form-group clearfix">
                                    ...
                                    <div class="form-group clearfix">
                                        ...
                                        <div>
                                            <input type="text" class="form-control" placeholder="输入联系方式">
                                        </div>
                                    </div>
                                    <div class="form-group clearfix">
                                        <label class="control-label">开户银行</label>
                                        <div>
                                            <input type="text"  class="form-control" placeholder="输入开户银行（选填）">
                                        </div>
                                    </div>
                                    <div class="form-group clearfix">
                                        <label class="control-label">银行账号</label>
                                        <div>
                                            <input type="text" class="form-control" placeholder="输入银行卡账号（选填）">
                                        </div>
                                    </div>
                                    <div class="form-group clearfix">
