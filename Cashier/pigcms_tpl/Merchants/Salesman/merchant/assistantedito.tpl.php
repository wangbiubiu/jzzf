                    		  ...
                    		  <div class="panel-body" style="padding: 0px; ">
                                <form class="form-horizontal form-border jbxi_bg clearfix" style="width: 80%; margin: 0 auto 60px; position: relative; border: 1px solid #EEEEEE;">
                                    ...
                                    <div class="form-group clearfix">
                                        ...
                                        <div>
                                            	<label><input type="radio"  name="level">店长</label>
                                            	<label><input type="radio"  name="level">店员</label>
                                        </div>
                                    </div>
                                    <div class="form-group clearfix">
                                    ...
                                    <div class="form-group clearfix">
                                        ...
                                        <div>
                                            <label><input type="checkbox">退款申请</label>
                                        </div>
                                    </div>
                                    <div class="form-group clearfix">
                                        ...
                                        <div>
                                         <label>
                                         	   <select>
                                            	<option>电子书籍发展责任有限公司</option>
                                            	<option>电子书籍发展责任有限公司1</option>
                                            	<option>电子书籍发展责任有限公司2</option>
                                            </select>
                                         </label>
                                        </div>
                                    </div>
