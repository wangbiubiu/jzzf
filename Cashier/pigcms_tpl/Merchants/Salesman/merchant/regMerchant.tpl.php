			...
			<form method="post" action="" enctype="multipart/form-data">
				<div class="row role_permission" style="position: relative; padding-bottom: 50px;">
					...
					<div>
						...
						<div class="clearfix">
							...
							<input type="hidden" name="mid" value="<?php echo $getdata['mid'];?>">
								<input type="text" placeholder="" id="name" name='company'>
						...
						<div class="clearfix">
							...
							<div>
								<input type="text" placeholder="" id="registered_address" name="address">
								<p style="display: none; color: red;"></p>
					...
					<div>
						...
						<div class="clearfix">
							...
							<div>
								<input type="text" placeholder="" id="registered_account" name="icence">
									<p style="display: none; color: red;"></p>
							</div>	
						</div>
						<div class="clearfix">
							<label><span>*</span>经营范围：</label>
								<div>
									<div id="business_scope" style="width: 350px; height: 100px; border: 1px solid #d0d0d0; overflow: hidden; overflow-y: auto;" contenteditable>
										<textarea name='mcarea' style='width: 100%;height: 100%;'></textarea>
						...
						<div class="clearfix">
							...
							<div>
								<div id="datepicker" class="input-daterange">
									<input type="text"  name="starttime" class="input-sm form-control" id="datestart" placeholder="开始时间" style=" margin-bottom: 0px; width: 35%; height: 30px;" name='shophours'>
									&nbsp;<span> 到 </span>&nbsp; 
							 		<input type="text"  name="endtime" class="input-sm form-control" id="dateend" placeholder="结束时间" style=" margin-bottom: 0px; width: 35%;height: 30px;"> 
									...
									<div id="js_upload_wrp">
									   <div class="img_upload_wrp group"> 
											...
											<div class="js_pager">
												...
												echo $str = '<div class="img_upload_box img_upload_preview_box js_edit_pic_wrp"><img  src="'.$reg['licencephoto'][$i].'"/><input name="licencephoto[]" class="imginput" type="hidden" value="'.$reg['groupID'][$i].'"><p class="img_upload_edit_area js_edit_area"><a class="icon18_common del_gray js_delete" href="javascript:;" onclick="DelthisImg($(this));" ></a></p></div>';
											} }?>
											</div> 
									   </div>
								  	</div>
				...
				<div>
						...
						<div class="clearfix">
							...
							<div>
								<input type="text" placeholder="" id="organization_code" name='occode'>
								<p style="display: none; color: red;"></p>
							</div>	
						</div>
						...
						<div class="clearfix">
							...
							<div>
								<div id="datepicker" class="input-daterange">
									<input type="text"  name="validatestart" class="input-sm form-control" id="datestart" placeholder="开始时间" style=" margin-bottom: 0px; width: 35%; height: 30px;">
									&nbsp;<span> 到 </span>&nbsp; 
							 		<input type="text"  name="validateend" class="input-sm form-control" id="dateend" placeholder="结束时间" style=" margin-bottom: 0px; width: 35%; height: 30px;"> 
								...
								<div>
									...
									<div id="js_upload_wrp">
									   <div class="img_upload_wrp group"> 
											...
											<div class="js_pager">
												<?php if (!empty($reg['occodephoto'])){ for ($i=0; $i <count($reg['occodephoto']); $i++) { 
												
												echo $str = '<div class="img_upload_box img_upload_preview_box js_edit_pic_wrp"><img  src="'.$reg['occodephoto'][$i].'"/><input name="groupIDList[]" class="imginput" type="hidden" value="'.$reg['occodephoto'][$i].'"><p class="img_upload_edit_area js_edit_area"><a class="icon18_common del_gray js_delete" href="javascript:;" onclick="DelthisImg($(this));" ></a></p></div>';
											} }?>
											</div> 
									   </div>
								  	</div>
	            ...
	            <div>
						...
						<div class="clearfix">
							...
							<div>
								<input type="text" placeholder="" id="document_name" name='idname'>
								<p style="display: none; color: red;"></p>
							</div>	
						</div>
								...
								<div>
									...
									<div id="js_upload_wrp">
									   <div class="img_upload_wrp group"> 
											...
											<div class="js_pager">
												<?php if (!empty($reg['idphotoA'])){ for ($i=0; $i <count($reg['idphotoA']); $i++) { 
												
												echo $str = '<div class="img_upload_box img_upload_preview_box js_edit_pic_wrp"><img  src="'.$reg['idphotoA'][$i].'"/><input name="idphotoA[]" class="imginput" type="hidden" value="'.$reg['idphotoA'][$i].'"><p class="img_upload_edit_area js_edit_area"><a class="icon18_common del_gray js_delete" href="javascript:;" onclick="DelthisImg($(this));" ></a></p></div>';
											} }?>
											</div> 
									   </div>
								  	</div>
								...
								<div>
									...
									<div id="js_upload_wrp">
									   <div class="img_upload_wrp group"> 
											...
											<div class="js_pager">
												<?php if (!empty($reg['idphotoB'])){ for ($i=0; $i <count($reg['idphotoB']); $i++) { 
												
												echo $str = '<div class="img_upload_box img_upload_preview_box js_edit_pic_wrp"><img  src="'.$reg['idphotoB'][$i].'"/><input name="idphotoB[]" class="imginput" type="hidden" value="'.$reg['idphotoB'][$i].'"><p class="img_upload_edit_area js_edit_area"><a class="icon18_common del_gray js_delete" href="javascript:;" onclick="DelthisImg($(this));" ></a></p></div>';
											} }?>
											</div> 
									   </div>
								  	</div>
						...
						<div class="clearfix">
							...
							<div>
								<div id="datepicker" class="input-daterange">
									<input type="text"  name="idstart" class="input-sm form-control" id="datestart" placeholder="开始时间" style=" margin-bottom: 0px; width: 35%; height: 30px;" name='idstart'>
									&nbsp;<span> 到 </span>&nbsp; 
							 		<input type="text" class="input-sm form-control" id="idend" placeholder="结束时间" style=" margin-bottom: 0px; width: 35%;height: 30px;" name='idend'> 
						...
						<div class="clearfix">
							...
							<div>
								<input type="text" placeholder="" id="id_number" name='idnum'>
								<p style="display: none; color: red;"></p>
							</div>	
						</div>					
	            </div>
