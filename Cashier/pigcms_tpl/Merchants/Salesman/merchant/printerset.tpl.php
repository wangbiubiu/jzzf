                    ...
                    <div class="ibox float-e-margins">
                    	...
                    	<div class="ibox-content" style="border-top:none;">
                    		  ...
                    		  <div class="panel-body" style="padding: 0px; ">
                                <form class="form-horizontal form-border jbxi_bg clearfix" style="width: 80%; margin: 0 auto 60px;position: relative; border: 1px solid #EEEEEE;">
                                	<h4 class="tit_h4"><span>设置打印机</span></h4>
                                    <div class="form-group clearfix">
                                        <label class="control-label ">打印机名称</label>
                                        <div>
                                            <input type="text" class="form-control" placeholder="打印机名称">
                                        </div>
                                    </div>
                                    <div class="form-group clearfix">
                                        <label class="control-label">打印联数</label>
                                        <div>
                                            <input type="text" class="form-control" placeholder="打印联数">
                                        </div>
                                    </div>
                                    <div class="form-group clearfix">
                                        <label class="control-label">是否启用</label>
                                        <div>
                                            <input type="text" class="form-control" placeholder="是">
                                        </div>
                                    </div>
                                    <div class="form-group clearfix">
                                        <label class="control-label">头部自定义信息</label>
                                        <div>
                                            <input type="text"  class="form-control" placeholder="头部自定义信息">
                                        </div>
                                    </div>
                                    <div class="form-group clearfix">
                                        <label class="control-label">底部自定义信息</label>
                                        <div>
                                            <input type="text" class="form-control" placeholder="底部自定义信息">
                                        </div>
                                    </div>
