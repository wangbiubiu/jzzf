...
<body>
							...
							<div class="ibox-content">
								<div class="group">
												...
												<div class="js_preview msg_card_section shop disabled focus itemdiv"> 
													<div id="js_color_preview" class="shop_panel" style="background-color: rgb(99, 179, 89);"> 
														...
														<div class="msg_area"> 
															...
															<p class="time timetype1"><span id="js_time_preview">有效期：永久有效</span></p> 
															<p class="time timetype2"><span id="js_time_preview">有效期：<span class="time1"><?php echo $datestart;?></span> - <span class="time2"><?php echo $dateend;?></span></span></p> 
														</div> 
													</div> 
									...
									<form id="js_editform" name="js_editform" class="media_edit" novalidate="novalidate" method="POST" action="?m=User&c=wxCoupon&a=docreateKq&typeid=<?php echo $typeid;?>"> 
										<input type="hidden" id="is_card" value="<?php echo intval($_count);?>" />
											...
											<div class="js_edit_content portable_editor to_left appmsg_editor econtent1" style="display: block;"> 
												...
												<div class="inner"> 
													<div class="editor_section"> 
														...
														<div class="appmsg_edit_item"> 
															<label class="frm_label" for=""> <strong class="title">折扣率<br /><span class="tips">(选填)</span></strong> </label> 
															<span class="frm_input_box"> <input type="text" placeholder="折扣 = (100 - 您填写的值)/10" class="frm_input ckinput" id="discount" name="discount" value="" /> </span> 
															<span class="tips">0~100之间的整数</span>
														</div> 
														...
														<div class="appmsg_edit_item bonus"> 
															<label class="frm_label"><strong class="title">激活送积分</strong></label> 
															<span class="frm_input_box"><input type="text" placeholder="10" class="frm_input" value="" name="bonus_rule[init_increase_bonus]"/></span> 积分
														</div>
														<div class="appmsg_edit_item bonus"> 
															<label class="frm_label"><strong class="title">单次上限</strong></label> 
															<span class="frm_input_box"><input type="text" placeholder="10000" class="frm_input" value="" name="bonus_rule[max_increase_bonus]"/></span> 积分
														</div>
														<div class="appmsg_edit_item bonus"> 
															<label class="frm_label"><strong class="title">积分抵扣</strong></label>
															<div class="input-daterange input-group">
																<span class="input-group-addon">每使用</span>
																<input type="text" value="" name="bonus_rule[cost_bonus_unit]" class="input-sm form-control" id="cost_bonus_unit" placeholder="100">
																<span class="input-group-addon">积分，抵扣</span>
																<input type="text" value="" name="bonus_rule[reduce_money]" class="input-sm form-control" id="reduce_money" placeholder="1">
																<span class="input-group-addon">元</span>
															</div>
														</div>
														<div class="appmsg_edit_item bonus"> 
															<label class="frm_label"><strong class="title">抵扣条件</strong></label>
															<div class="input-daterange input-group">
																<span class="input-group-addon">订单满</span>
																<input type="text" value="" name="bonus_rule[least_money_to_use_bonus]" class="input-sm form-control" id="least_money_to_use_bonus" placeholder="100">
																<span class="input-group-addon">元可用，单笔上限</span>
																<input type="text" value="" name="bonus_rule[max_reduce_bonus]" class="input-sm form-control" id="max_reduce_bonus" placeholder="10">
																<span class="input-group-addon">积分</span>
															</div>
														</div>
														...
														<div class="appmsg_edit_item radio_item"> 
															<div class="frm_control_group radio_row"> 
																<label class="frm_label" for="">会员卡激活方式</label> 
																<div class="frm_controls frm_vertical_lh"> 
																	<div class="radio_control_group group"> 
																		<label class="frm_radio_label frm_radio_input selected" for="active0"> <i class="icon_radio"></i><input type="radio" class="frm_radio js_validtime" value="0" id="active0" checked="checked" name="activate"/><span class="lbl_content"> 领卡自动激活 &nbsp;&nbsp;</span> </label> 
																	</div> 
																</div> 
																<div class="frm_controls frm_vertical_lh"> 
																	<div class="radio_control_group group"> 
																		<label class="frm_radio_label frm_radio_input selected" for="active1"> <i class="icon_radio"></i><input type="radio" class="frm_radio js_validtime" value="1" id="active1" name="activate"/><span class="lbl_content"> 领卡一键激活 &nbsp;&nbsp;</span> </label> 
																	</div> 
																</div> 
															</div> 
														</div> 
								...
								<div class="tool_bar border tc">
									<button id="create_card" class="btn btn-primary" style="height: 36px;"> 提交审核 </button>
								</div>
							</div>
						</div>
                    </div>
	...
	<!-- DROPZONE -->
<script type="text/javascript">var wxCouponType = 5;</script>
