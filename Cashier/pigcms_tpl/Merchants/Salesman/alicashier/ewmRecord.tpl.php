            ...
            <div class="row">
            	<div class="col-lg-12">
            	    <div class="ibox float-e-margins">
						...
						<li> <a href="<?php echo $this->SiteUrl;?>/merchants.php?m=User&c=alicashier&a=index">收银台</a> </li> 
						<li> <a href="<?php echo $this->SiteUrl;?>/merchants.php?m=User&c=alicashier&a=payRecord">支付宝收款</a> </li> 
         ...
         <table class="ui-table ui-table-list" data-page-size="20" style="padding: 0px;"> 
          ...
          <tbody class="js-list-body-region">
           ...
           <tr class="widget-list-item">
			...
			<?php if($ovv['ispay']>0){?>
			<div>
			<img src="<?php echo $this->RlStaticResource;?>images/qrcodeyzf.png" width="90">
			</div>
			<?php }else{?>
		...
		<div class="modal-dialog">
			<div class="modal-content animated bounceInRight">
				<div class="modal-header">
                    ...
                    <h4 class="modal-title">支付宝支付二维码</h4>
					<span>请用支付宝扫码支付</span>
                </div>
	   ...
	   if(bodyW>350) bodyW=350;
        $(document).ready(function(){
		   ...
		   $(".ui-centered-image").click(function(){
		     	var ooid=$(this).find('input').val();
				 $.ajax({
					url: "?m=User&c=alicashier&a=getAliEwmByid",
					type: "POST",
					dataType: "json",
					data:{ooid:ooid},
