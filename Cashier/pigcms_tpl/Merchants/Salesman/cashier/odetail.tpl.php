			   ...
			   <tbody>
				...
				<tr>
				 ...
				 <td>&nbsp;&nbsp;<?php if($orderInfo['pay_way']=='weixin'){ echo "微信";
					 ...
					 echo "支付";
				 }elseif($orderInfo['pay_way']=='alipay'){
					  echo "支付宝";
				      if($orderInfo['pay_type']=='bar_code'){
					      echo " - 条码";
					  }elseif($orderInfo['pay_type']=='qrpay'){
					      echo " - 二维码";
					  }
					  echo "支付";
				 }else{
				    echo "其他支付：".$orderInfo['pay_way'];
				 }?></td>
				</tr>
				<tr>
				 <th>第三方支付订单ID：</th>
				...
				<tr>
				 <th>收款门店：</th>
				 <td>&nbsp;&nbsp;
				 <?php echo $orderInfo['storename'];?></td>
				</tr>
				<tr>
				 <th>收款人：</th>
				 <td>&nbsp;&nbsp;<?php echo $orderInfo['optername'];?></td>
				</tr>
