                    ...
                    <div class="col-lg-12">
						...
						<div class="form-group">
							...
							<div class="form-group input-group" style="display: block;width:77%;">
								<select class="form-control m-b" id="store">
								<?php if (empty($this->storeid)) {?>
								<option>请选择门店</option>
								<?php }?>
								<?php foreach ($stores as $store) {?>
								<option value="<?php echo $store['id'];?>"><?php echo $store['business_name'] . $store['branch_name'];?></option>
								<?php }?>
								</select>
							</div>
						</div>
						<div id="dataselect" class="form-group">
                            ...
                            <div class="ibox-content" id="cibox-content">
                                    <div id="canvasdesc">
                                        ...
                                        <h3 class="m-b-xs">
                                           <span>微信刷卡次数<strong class="price1">0</strong></span> 
										   	  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span>微信扫码次数<strong class="price2">0</strong></span><br/>
											  <span>支付宝条码次数<strong class="price3">0</strong></span> 
										   	  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span>支付宝扫码次数<strong class="price4">0</strong></span>
                                        </h3>
                                        <!---<small></small>--->
                                    </div>
...
$(function () {
    ...
    var doughnutData_m = [
        {
            value: <?php echo $mt_wxcount;?>,
            color: "#a3e1d4",
            highlight: "#1ab394",
            label: "微信刷卡次数（正扫）"
        },
        {
            value: <?php echo $wt_wxcount;?>,
            color: "#33EA90",
            highlight: "#1ab394",
            label: "微信扫码次数（反扫）"
        },
		{
            value: <?php echo $mt_alicount;?>,
            color: "#7989F9",
            highlight: "#1ab394",
            label: "支付宝条码次数（正扫）"
        },
		{
            value: <?php echo $wt_alicount;?>,
            color: "#3881F2",
            highlight: "#1ab394",
            label: "支付宝扫码次数（正扫）"
        },
