	   ...
	   <div class="row border-bottom">
        ...
        <div class="navbar-header">
            ...
            <ul class="clearfix ">
            	...
            	<dl <?php if(ROUTE_CONTROL !='pay' && ROUTE_CONTROL !='pfpay') echo 'class="nav_selected"'; ?>>
            		 <?php if (!($this->eid > 0)) { ?><a href="/merchants.php?m=Salesman&c=index&a=index"><?php }else {?>
            	...
            	<dl <?php if(ROUTE_CONTROL=='pay' || ROUTE_CONTROL=='pfpay') echo 'class="nav_selected"';?>>
                         <?php if (!($this->eid > 0)) { ?><a href="/merchants.php?m=Salesman&c=pay&a=SetAccount"><?php }else {?>
                             <?php if ( $_SESSION['E_LEVEL']  == 1 ) { ?>
                                <a href="/Salesman.php?m=Salesman&c=Modify&a=setPwd">
                             <?php }else{ ?>
                                    <a href="#">                  
                         <?php } }?>
            ...
            <ul class="nav navbar-top-links navbar-right">
			   ...
			   <li class="dropdown" id="help-link">
                ...
                <li>
                    <a  href="?m=Salesman&c=index&a=logout">
