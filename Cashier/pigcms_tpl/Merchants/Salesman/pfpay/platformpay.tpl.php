            ...
            <div class="row">
            	<div class="col-lg-12">
					...
					<div class="ibox-title" id="screenForm">
					  <form method="get" action="/merchants.php?m=User&c=pfpay&a=platformpay">
					    <input type="hidden" value="User" name="m" >
						<input type="hidden" value="pfpay" name="c" >
						<input type="hidden" value="platformpay" name="a" >
    ...
    <div>
      ...
      <div class="cashier-realtime"> 
       <div class="realtime-title-block clearfix"> 
        <h1 class="realtime-title">收款情况 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span style="color:green;">总金额：<span><?php echo $totalMoney;?></span> 元 &nbsp;&nbsp; 退款总额：<span><?php echo $refundMoney;?>元 &nbsp;&nbsp; 已对账总额：<span><?php echo $dzRefundMoney;?></span> 元 &nbsp;&nbsp; 平台未对账总额：<span><?php echo $pfOweMoney;?></span> 元 &nbsp;&nbsp; </span></h1> 
       </div> 
      </div> 
         ...
         <table class="ui-table ui-table-list" data-page-size="20" style="padding: 0px;"> 
          ...
          <tbody class="js-list-body-region" id="table-list-body">
           ...
           <tr class="widget-list-item">
			...
			<td><?php if($ovv['state']==2){echo '<font color="#047609">已对账</font>';}else{echo '<font color="#E00A23">未对账</font>';}?></td>
