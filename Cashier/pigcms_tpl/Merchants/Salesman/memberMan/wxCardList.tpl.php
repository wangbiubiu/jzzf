         ...
         <table class="ui-table ui-table-list" data-page-size="20" style="padding: 0px;"> 
          ...
          <tbody class="js-list-body-region" id="table-list-body">
           ...
           <tr class="widget-list-item">
			...
			<a class="btn btn-sm btn-primary"  href="?m=User&c=memberMan&a=bonus&id=<?php echo $rvv['id'];?>" style="vertical-align:top;"> 积分操作详情 </a> 
			<a class="btn btn-sm btn-primary"  href="?m=User&c=memberMan&a=paycell&id=<?php echo $rvv['id'];?>" style="vertical-align:top;">支付记录 </a> 
			</td>
           </tr>
		   <?php }}else{?>
...
$(document).ready(function(){
	...
	function show_detail(id){
		$.ajax({
			url: "?m=User&c=memberMan&a=membercardinfo",
			type: "POST",
			dataType: "json",
			data:{id:id},
