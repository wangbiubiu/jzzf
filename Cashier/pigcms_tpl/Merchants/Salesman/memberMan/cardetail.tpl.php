            ...
            <div class="row wrapper border-bottom white-bg page-heading">
				<div class="col-lg-10">
					...
					<ol class="breadcrumb">
						<li><a>User</a></li>
						<li><a>wxCoupon</a></li>
						<li class="active"><strong>cardetail</strong></li>
					</ol>
				</div>
				...
				<div class="ibox float-e-margins">
					<div class="ibox-title">
						<div class="form-group">
							<span>卡券ID：<?php echo $cardinfo['card_id'];?></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span>卡券状态：<?php if(!($cardinfo['istowx']>0)){echo '本地卡券不需审核';}elseif($cardinfo['status']==0){echo '审核中';}elseif($cardinfo['status']==1){echo '已审核';}elseif($cardinfo['status']==2){echo '未通过';}?></span>
						</div>
					</div>
											...
											<div class="wrp">
												<div style="background-color: <?php echo $kqcontent['colorV'];?>;border-bottom-color: <?php echo $kqcontent['colorV'];?>;" class="top">
													<div class="logo group">
														<div class="avartar l">
															<img class="js_noreferimg" src="<?php echo $mset['logurl'];?>">
														</div>
													...
													<div class="msg">
														...
														<p class="time"><?php if ($cardinfo['begin_timestamp'] == 0 && $cardinfo['end_timestamp'] == 0) {?>永久有效<?php } else {?>有效期 <?php echo date('Y-m-d',$cardinfo['begin_timestamp']);?>至<?php echo date('y-m-d',$cardinfo['end_timestamp']); }?></p>
													</div>
													<div class="deco"></div>
												</div>
												<div class="wrp_content">
													...
													<div class="wrp_section">
														<ul class="info_list">
															...
															<li class="info_li">
																<p class="info">适用门店</p> <span class="supply_area"><?php echo $kqcontent['shop_id_count'];?>家<i class="ic ic_go"></i></span>
															</li>
														</ul>
													</div>
									...
									<div class="msg_preview_panel l">
										<div class="msg_section msg_pre_view">
											<ul>
												...
												<li class="group"><span class="l title">卡券类型</span>
													<div class="msg"><?php echo $this->card_type[$cardinfo['card_type']]['zhname'];?></div>
												</li>
												<li class="group"><span class="l title">卡券标题</span>
													<div class="msg"><?php echo $cardinfo['card_title'];?></div>
												</li>
												<li class="group"><span class="l title">副标题</span>
												...
												<li class="group">
													...
													<div class="msg">
														<span style="background-color:<?php echo $kqcontent['colorV'];?>;" class="colour_block"><?php echo $kqcontent['colorV'];?></span>
													</div>
												</li>
												<li class="group">
													<span class="l title">有效期</span>
													<div class="msg">
														<span id="js_time_container"><?php if ($cardinfo['begin_timestamp'] == 0 && $cardinfo['end_timestamp'] == 0) {?>永久有效<?php } else { echo date('Y-m-d',$cardinfo['begin_timestamp']) . '至' . date('y-m-d',$cardinfo['end_timestamp']); }?></span>
										...
										<div class="msg_section msg_pre_view">
											<ul>
												...
												<li class="group"><span class="l title">库存</span>
													<div class="msg"><?php echo $cardinfo['quantity'];?></div>
												</li>
												<li class="group"><span class="l title">销券条码</span>
													<div class="msg">二维码</div></li>
												<li class="group"><span class="l title">操作提示</span>
													<div class="msg"><?php echo $kqcontent['notice'];?></div>
												</li>
												<li class="group"><span class="l title">领取限制</span>
													<div class="msg">每个用户限领<?php echo $kqcontent['get_limit'];?>张</div>
												</li>


												<li class="group"><span class="l title">转赠设置</span>
										...
										<div class="msg_section msg_pre_view">
											<ul>
												...
												<li class="group"><span class="l title">使用须知</span>
													<div class="msg"><?php echo $kqcontent['description'];?></div>
												</li>
												<li class="group"><span class="l title">优惠详情</span>
													<div class="msg">
													<?php
														if (in_array ($cardinfo ['card_type'], array (0, 1, 3))) {
										...
										<?php if (($cardinfo ['card_type'] == 5) && $cardinfo['kqexpand']['supply_bonus']) {?>
										<div class="msg_section msg_pre_view">
											<ul>
												<li class="section_title">积分说明</li>
												<li class="group">
													<span class="l title">规则说明</span>
													<div class="msg"><?php echo $cardinfo['kqexpand']['bonus_rules'];?></div>
												</li>
												<?php if($cardinfo['kqexpand']['bonus_cleared']){?>
												<li class="group">
													<span class="l title">清零规则</span>
													<div class="msg"><?php echo $cardinfo['kqexpand']['bonus_cleared'];?></div>
												</li>
												<?php } ?>
												<li class="group">
													<span class="l title">积分规则</span>
													<div class="msg">消费￥<?php echo $cardinfo['kqexpand']['bonus_rule']['cost_money_unit'];?>分，增加<?php echo $cardinfo['kqexpand']['bonus_rule']['increase_bonus'];?>积分</div>
												</li>
												<li class="group">
													<span class="l title">初始积分</span>
													<div class="msg"><?php echo $cardinfo['kqexpand']['bonus_rule']['init_increase_bonus'];?></div>
												</li>
												<li class="group">
													<span class="l title">积分上限</span>
													<div class="msg"><?php echo $cardinfo['kqexpand']['bonus_rule']['max_increase_bonus'];?></div>
												</li>
											</ul>
										</div>
										<?php }?>
										<?php if (($cardinfo ['card_type'] == 5) && $cardinfo['kqexpand']['supply_balance']) {?>
										<div class="msg_section msg_pre_view">
											<ul>
												<li class="section_title">储值说明</li>
												<li class="group">
													<span class="l title">储值说明</span>
													<div class="msg"><?php echo $cardinfo['kqexpand']['balance_rules'];?></div>
												</li>
											</ul>
										</div>
										<?php }?>		
										...
										<div class="msg_section msg_pre_view">
											<ul>
												<li class="section_title">服务信息 <!--<a id="js_modifyservice_btn" href="javascript:void(0);">修改</a>---></li>
												<li class="group">
													...
													<div class="msg msg_table">
														<div id="js_shoplist" class="table_wrp shop_list">
															<table cellspacing="0" class="table">
																<thead class="thead">
																	<tr>
																		<th class="table_cell" style="width: 30%"><div
																				class="td_panel tl">门店名称</div></th>
																		<th class="table_cell"><div class="td_panel tl">地址</div></th>
																	</tr>
																</thead>
																<tbody class="tbody">
																	<?php
																	foreach ($kqcontent ['location_id_list'] as $vv) {
										...
										<div class="msg_section msg_pre_view">
											<ul>
												...
												<li class="group"><span class="l title">&nbsp; </span>
													<div class="msg">
														<ul class="info_list custom_list">
														<?php if(!empty($kqcontent['custom_url_name'])) {?>
															<li class="info_li">
																<p class="info">
																	<a target="_blank" href="<?php echo $kqcontent['custom_url'];?>"><?php echo $kqcontent['custom_url_name'];?></a>
																</p> 
																<span class="supply_area"><?php echo $kqcontent['custom_url_sub_title'];?><i class="ic ic_go"></i></span>
															</li>
															<?php
															...
															<li class="info_li">
																<p class="info">
																	<a target="_blank" href="<?php echo $kqcontent['promotion_url'];?>"><?php echo $kqcontent['promotion_url_name'];?></a>
																</p> 
																<span class="supply_area"><?php echo $kqcontent['promotion_url_sub_title'];?><i class="ic ic_go"></i></span>
															</li>
															<?php
															...
															<li class="info_li">
																<p class="info">
																	<a target="_blank" href="<?php echo $cardinfo['kqexpand']['custom_cell1']['url'];?>"><?php echo $cardinfo['kqexpand']['custom_cell1']['name'];?></a>
																</p> 
																<span class="supply_area"><?php echo $cardinfo['kqexpand']['custom_cell1']['tips'];?><i class="ic ic_go"></i></span>
															</li>
															<?php }?>
