			...
			c.tmpl = function(d){
				var e = {
					weixin : {
						...
						micropay : '<h3 class="m-t-none m-b">收款</h3><p>扫码支付确认信息.</p><form role="form" action="" id="micropay"><div class="form-group"><label>收款备注</label> <input type="text" placeholder="收款备注" name="goods_name"  id="goods_name" class="form-control"></div><div class="form-group"><label>支付金额</label> <input type="text" placeholder="支付金额(至少0.01元)" name="goods_price" id="goods_price" class="form-control"></div><div><button class="btn btn-sm btn-primary pull-right m-t-n-xs" type="submit"><strong>扫码收款</strong></button></div></form>',
						micropayRefund : '<h3 class="m-t-none m-b">退款</h3><p>扫码支付退款</p><p>扫支付交易详情页的条形码来退款.</p><form role="form" action="?m=User&c=cashier&a=wxSmRefund" id="wxSmRefund"><div><button class="btn btn-sm btn-primary pull-right m-t-n-xs" type="submit"><strong>扫码退款</strong></button></div></form>',
					}
				}
				var f;
				$.each(d,function(g,h){
