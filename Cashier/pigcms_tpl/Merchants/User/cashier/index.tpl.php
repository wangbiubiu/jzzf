...
<html>
    <head>
        ...
        <style>
            ...
            .cashier-desk .realtime-pay .pay-code {
                float: left;
                margin-left: 50px;
                padding: 0 20px;
                text-align: center;
            ...
            .cashier-desk .realtime-pay .pay-config {
                display: inline-block;
                float: none;
            }
                        ...
                        <div class="col-lg-12">
                            <div class="ibox float-e-margins">
                                <div class="ibox-title clearfix">
                                    ...
                                    <strong style='font-size: 18px;'>指定金额收款</strong> 
                                </div>
                                            ...
                                            <div class="page-cashier-box"> 
                                                <div class="cashier-desk clearfix"> 
                                                    ...
                                                    <div class="realtime-pay js-pay-code-region clearfix">
                                                        <div style="text-align: center; max-width: 930px; margin: 0 auto;">
                                                            <div class="pay-config" style="margin-top: 7%; margin-bottom: 40px;"> 
                                                                        ...
                                                                        foreach ($neworder as $ovv) {
                                                                            ...
                                                                            <tr class="widget-list-item">
                                                                                ...
                                                                                <td><?php
                                                                                    ...
                                                                                    ?></td> 
                                                                                <td><?php $paytime = $ovv['paytime'] > 0 ? $ovv['paytime'] : $ovv['add_time'];
                                                                                    echo date('Y-m-d H:i:s', $paytime); ?></td> 
    ...
    <?php }
                                                                        ...
                                                                        <tr class="widget-list-item"><td colspan="10">暂无订单</td></tr>
<?php } ?>
                                                                </tbody> 
                                                            </table> 
        ...
        <script>
                                                                                ...
                                                                                $(document).ready(function () {
                                                                                    ...
                                                                                    $("#qr-code-autopay").html('').css('background-color', '#FFF').qrcode({
                                                                                        ...
                                                                                        width: qwidth, //宽度 
                                                                                        height: qheight, //高度
                                                                                        text: '<?php echo $this->SiteUrl; ?>/merchants.php?m=Index&c=pay&a=autopay&mid=<?php echo $this->mid; ?>&eid=<?php echo $this->eid; ?>&storeid=<?php echo $this->storeid; ?>' //任意内容 
                                                                                                });
                                                                                                $("#qr-code-auto").html('').css('background-color', '#FFF').qrcode({
                                                                                                    //render: "table", //table方式 
                                                                                                    width: qwidth, //宽度 
                                                                                                    height: qheight, //高度
                                                                                                    text: '<?php echo $this->SiteUrl; ?>/merchants.php?m=Index&c=pay&a=autopay&mid=<?php echo $this->mid; ?>&eid=<?php echo $this->eid; ?>&storeid=<?php echo $this->storeid; ?>' //任意内容 
