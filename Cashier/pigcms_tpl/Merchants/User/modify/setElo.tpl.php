                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-content">
							...
							<form action="?m=User&c=modify&a=employersDelAll" class="employersDelAll" method="post">
                            <table class="footable table table-stripped toggle-arrow-tiny" data-page-size="10" data-filter=#filter>
                                <thead>
                                <tr>
                                    <th class="check-mail">序号</th>
                                    <th>员工名称</th>
    	...
    	<div class="modal-dialog modal-lg">
        	<div class="modal-content">
                ...
                <div class="modal-body clearfix">
					<form id="employersForm" class="form" action="?m=User&c=modify&a=employersAdd" method="post">
						<div class="col-lg-12">
							<div class="ibox">
		...
		!function(a,b){
			...
			employers.init = function(){
				...
				b('.formSubmit').click(function(){
					if(b('#account').val() != ''){
						$.post('?m=User&c=modify&a=checkAccount',{account:b('#account').val()},function(re){
							if(re.status == 0){
				...
				b('.employersDel').click(function(){
					...
					swal({
						...
						$.post('?m=User&c=modify&a=employersDel',{eid:c.attr('data-id')},function(re){
							if(re.status == 0){
								swal("错误", re.msg+" :)", "error");
							}else{
