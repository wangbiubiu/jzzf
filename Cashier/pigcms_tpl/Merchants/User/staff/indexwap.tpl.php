...
<div style="width: 100%;height: 100px;background-color: #008fd3;">
    <div style="width: 100%;height: 50px;line-height: 50px;">
        ...
        <a href="/merchants.php?m=User&c=staff&a=setMyself" style="display: block;float:right;margin-right: 10px;color:#fff;">账户管理 ></a>
    </div>
</div>
...
<div style="margin: 30px 10px;">
    <a href="/merchants.php?m=User&c=staff&a=myOrders" style="width: 25%;text-align: center;display: block;float:left;color:#333;">
        <div>
