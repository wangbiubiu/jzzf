            ...
            <div class="wrapper wrapper-content animated fadeInRight" >
              	...
              	<div class="notice_nr" style="background: #FFFFFF; width: 100%; padding-bottom: 30px; margin-top: 30px;">
              		<div class="notice_nr_tit">
              			...
              			<p><?php echo empty($notice['title'])?'':$notice['title'];?></p>
              			<p><span>来源：<?php echo empty($notice['source'])?'':$notice['source'];?></span><span>时间：<?php echo date ('Y-m-d H:i:s',empty($notice['addtime'])?time():$notice['addtime']);?></span></p>
              		</div>
              		<div class="notice_nr_zt">
                    <?php echo   htmlspecialchars_decode(empty($notice['content'])?'':$notice['content']);?>
              	</div>
