                        ...
                        <form action="/merchants.php?m=User&c=manager&a=CashierCount" method="get">
                            ...
                            <div id="dataselect" class="form-group" style="padding: 0 10px;width:98%">
                                <div id="datepicker" class="input-daterange">
                                    ...
                                    <input class=" form-control" type="text" name="branch_name" placeholder="输入员工名称" value="<?php if(isset($getdata['username'])) echo $getdata['username'];?>" style="width: 20%;border-radius: 7px;height: 40px; margin-bottom: 0px;">
                            ...
                            if(!empty($store)){
                                foreach($store as $k=>$v){ ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <p><?php echo  $v['wxrate']*100 ."%" ?></p>
                                            <p><?php echo  $v['alirate']*100 ."%" ?></p>
                                        </td>
                                        <td>
                                            <p><?php echo  $v['wxincome'] ?> 元</p>
                                            <p><?php echo  $v['aliincome'] ?> 元</p>
                                        </td>
                                        <td><button><a href="/merchants.php?m=User&c=manager&a=StaffCount&id=<?php echo $v['eid']?>">查看</a></button></td>
                                    </tr>
