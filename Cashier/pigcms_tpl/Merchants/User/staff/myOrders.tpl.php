...
<head>
    ...
    <style type="text/css">
        ...
        .shanxin{float: right; width: 400px; height: 240px;margin-top:-170px; position: relative; margin-bottom: 20px; border: 1px solid #cccccc;}
                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <div class="form-group" style="border-bottom: 1px solid #cccccc; font-size: 18px;">
                                <label class="font-noraml">收银员数据</label>
                                ...
                                <form method="get" action="/merchants.php?m=User&c=staff&a=myOrders">
                                    ...
                                    <div id="dataselect" class="form-group" style="padding: 0 10px;">
                                        <div id="datepicker" class="input-daterange">
                                            ...
                                            <input type="text" value="<?php if(isset($getdata['start'])){echo $getdata['start'];}else{echo date('Y-m-d');}?>" name="start" class="input-sm form-control" id="datestart" placeholder="开始时间" style=" margin-bottom: 0px; width: 120px; height: 30px; border-radius: 3px">
                                            &nbsp;<span> 到 </span>&nbsp;
                                            <input type="text" value="<?php if(isset($getdata['end'])){echo $getdata['end'];}else{echo date('Y-m-d');}?>" name="end" class="input-sm form-control" id="dateend" placeholder="结束时间" style=" margin-bottom: 0px; width: 120px; height: 30px; border-radius: 3px"">
                                            &nbsp;&nbsp;&nbsp;<input class="btn btn-primary" type="submit" value="查 询" style="width:70px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="btn btn-primary"  style="width:100px;" href="?m=User&c=staff&a=data2Excel" >导出Excel</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
                            <div class="clearfix">
                               ...
                               描述：统计图
                           -->
                                <div class="shanxin clearfix " style="position: absolute;right: 35px; margin-top:0px; top: 166px; height: 210px">
                                    ...
                                    if(!empty($neworder)){
                                        foreach($neworder as $v){
                                            ...
                                            <tr>
                                                ...
                                                <td><?php if($v['refund'] == '2'){echo 0;}else{echo $v['goods_price'];}?></td>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var doughnutData_m = [
            {
                value: <?php if(!$weixin){ echo 0;}else{ echo $weixin;} ?>,
                color: "#33EA90",
                highlight: "#4BFFA8",
                label: "微信支付"
            },
            {
                value: <?php if(!$alipay){ echo 0;}else{ echo $alipay;} ?>,
                color: "#00a3d2",
                highlight: "#24c7f6",
                label: "支付宝"
            },
