    ...
    <div id="wrapper">
                    ...
                    <div class="col-lg-12">
						...
						<div class="ibox-title">	
						 <div class="alert alert-warning" style="font-size: 16px;">
								...
								<?php if($istowx==0){?>
								 <p style="color:red;">您选择的是不将创建的卡券同步推送到微信</p>
								<?php }?>
                            </div>
						</div>
		...
		<div id="js_preview_area" class="media_preview_area">
			...
			<form id="js_editform" name="js_editform" class="media_edit" novalidate="novalidate" method="POST" action="?m=User&c=wxCoupon&a=docreateKq&typeid=<?php echo $typeid;?>"> 
			 <div id="js_edit_area" class="media_edit_area" style="margin-top: 0px;">
			  <div class="js_edit_content portable_editor to_left appmsg_editor econtent1" style="display: block;"> 
			   <input type="hidden" value="<?php echo $typeid;?>" name="ctype" />
			   <input type="hidden" value="<?php echo $istowx;?>" name="istowx" />
			   <div class="inner"> 
				<div class="editor_section"> 
				 ...
				 <?php if($typeid==4){?>
				 <div class="appmsg_edit_item"> 
				  <label class="frm_label" for=""> <strong class="title">减免金额</strong> </label> 
				  <div class="input_submsg"> 
				   <span class="frm_input_box"> <input type="text" placeholder="" class="frm_input valid" name="reduce_cost" id="js_reduce_cost" value=""  onkeyup="value=value.replace(/[^1234567890\.]+/g,'')"/> </span> 
				   <span>元</span> 
				  </div> 
				  <p class="frm_tips">减免金额只能是大于0.01的数字</p>
				 </div> 
				 <div class="appmsg_edit_item appmsg_input_submsg_item group appmsg_edit_item_label_mult"> 
				  <label class="frm_label" for=""> <strong class="title">抵扣条件</strong> <br /><p class="tips">(选填)</p> </label> 
				  <div class="input_submsg group"> 
				   <span class="frm_input_box"> <input type="text" placeholder="" class="frm_input" name="least_cost" id="js_least_cost" value="" onkeyup="value=value.replace(/[^1234567890\.]+/g,'')"/> </span> 
				   <span>元</span> 
				  </div> 
				  <p class="frm_tips">消费满多少元可用。如不填写则默认：消费满任意金额可用。只能是大于0.01的数字</p> 
				 </div> 
				 <?php }elseif($typeid==2){?>
					<div id="js_discount_item" class="appmsg_edit_item">
					<label class="frm_label" for="">
					<strong class="title">折扣额度</strong>
					</label>
					<div class="input_submsg">打
					<span class="frm_input_box" style="width: 202px;">
					<input type="text" placeholder="请填写1-9.9之间的数字" class="frm_input" name="discount" id="js_discount" value="" maxlength="3">
					</span>
					<span class="input_sub_msg">折</span>
					</div>
					<p class="frm_msg fail">
						<span class="frm_msg_content" for="js_discount">折扣额度只能是大于等于1且小于10的数字</span>
					</p>
				 ...
				 <div class="appmsg_edit_item"> 
				  <label class="frm_label" for=""> <strong class="title">自定义来源<br /><span class="tips">(选填)</span></strong> </label> 
				  <span class="frm_input_box"> <input type="text" placeholder="" class="frm_input ckinput" id="source" name="base_info[source]" value="" /> </span> 
				  <span class="tips"><span id="js_source_tip">0</span>/<span id="js_source_limit">12</span></span>
				  ...
				  <div class="frm_control_group radio_row"> 
				   ...
				   <div class="frm_controls frm_vertical_lh"> 
					<div class="radio_control_group group"> 
					 <label class="frm_radio_label frm_radio_input selected" for="checkbox1"> <i class="icon_radio"></i>  <input type="radio" class="frm_radio js_validtime" value="1" id="checkbox1" checked="checked" /><span class="lbl_content"> 固定日期 &nbsp;&nbsp;</span> </label> 
					...
					<!--<div class="radio_control_group frm_radio_input group"> 
					 <label class="frm_radio_label" for="checkbox2"> <i class="icon_radio"></i>  <input type="radio" class="frm_radio js_validtime" value="2" id="checkbox2" /> <span class="lbl_content"> 领取后，&nbsp;&nbsp;</span></label> 
					 <span id="js_from_day_container" class="dropdown_menu disabled"><a class="btn dropdown_switch jsDropdownBt" href="javascript:;"><label class="jsBtLabel">当天</label><i class="arrow"></i></a> 
					  <div class="dropdown_data_container jsDropdownList" style="display: none;"> 
					   <ul class="dropdown_data_list"> 
						<li class="dropdown_data_item "> <a data-name="当天" data-index="0" data-value="0" class="jsDropdownItem" href="javascript:;" onclick="return false;">当天</a> </li> 
						<li class="dropdown_data_item "> <a data-name="1天" data-index="1" data-value="1" class="jsDropdownItem" href="javascript:;" onclick="return false;">1天</a> </li> 
					   </ul> 
					  </div> </span> 
					</div> --->
				   </div> 
				  ...
				  <div class="frm_control_group"> 
				   ...
				   <div class="frm_controls frm_vertical_lh"> 
					...
					<label class="frm_checkbox_label selected" for="checkbox12"> <i class="icon_checkbox"></i> <span class="lbl_content">用户领券后可转赠其他好友</span> <input type="checkbox" class="frm_radio frm_checkbox" checked="checked" id="checkbox12" name="base_info[can_give_friend]" value="1"/> </label> 
				     ...
				     <?php if($istowx==0){?>
				      <div style="float: left;left: 200px;position: relative;top: -37px;color:#FF4A33">不将卡券推送到微信，这两项设置将失效</div>
					 <?php }?>
				  </div> 
				 </div> 
				</div> 
				<div class="editor_section"> 
				 ...
				 <div class="appmsg_edit_item row_item"> 
				  <div id="js_destroy_type" class="frm_control_group radio_row"> 
				   ...
				   <!--<div class="frm_controls frm_vertical_lh"> 
					<div class="radio_control_group group"> 
					 <label class="frm_radio_label" for="checkbox3"> <i class="icon_radio"></i> <span class="lbl_content">仅卡券号</span> <input type="radio" class="frm_radio" value="0" id="checkbox3" /> <p class="frm_tips">只显示卡券号，验证后可进行销券</p> </label> 
					</div> 
					<div class="radio_control_group group"> 
					 <label class="frm_radio_label" for="checkbox4"> <i class="icon_radio"></i> <span class="lbl_content">二维码</span> <input type="radio" class="frm_radio" value="2" id="checkbox4" /> <p class="frm_tips">包含卡券信息的二维码，扫描后可进行销券</p> </label> 
					</div> 
					<div class="radio_control_group group"> 
					 <label class="frm_radio_label" for="checkbox5"> <i class="icon_radio"></i> <span class="lbl_content">条形码</span> <input type="radio" class="frm_radio" value="1" id="checkbox5" /> <p class="frm_tips">包含卡券信息的条形码，扫描后可进行销券</p> </label> 
					</div> 
				   </div>-->
			  ...
			  <div class="js_edit_content portable_editor to_left appmsg_editor econtent3" style="display: none;"> 
			   ...
			   <div class="appmsg_edit_item textarea_item">
				<label class="frm_label">
					<strong class="title">优惠详情</strong>
					</label>
					<div class="frm_controls">
						<div class="frm_textarea_box">
							<textarea placeholder="" name="default_detail" class="frm_textarea valid" id="detailtext"></textarea>
						</div>
					</div>
					<p class="frm_msg fail"><span for="detailtext" class="frm_msg_content">优惠详情不能为空且长度不超过1024个汉字</span></p>
				</div>
				<?php }elseif($typeid==1){?>
				<div class="appmsg_edit_item textarea_item">
				<label class="frm_label">
					...
					<div class="frm_controls">
						<div class="frm_textarea_box">
							<textarea placeholder="" name="deal_detail" class="frm_textarea valid" id="detailtext"></textarea>
						</div>
					</div>
					<p class="frm_msg fail"><span for="detailtext" class="frm_msg_content">优惠详情不能为空且长度不超过1024个汉字</span></p>
				</div>
				...
				<label class="frm_label">
					...
					<div class="frm_controls">
						<div class="frm_textarea_box">
							<textarea placeholder="" name="gift" class="frm_textarea valid" id="detailtext"></textarea>
						</div>
					</div>
					<p class="frm_msg fail"><span for="detailtext" class="frm_msg_content">优惠详情不能为空且长度不超过1024个汉字</span></p>
				</div>
				...
				<div class="ibox float-e-margins">
				   <div class="table-responsive">
				     <table class="table table-striped">
									...
									?>
                                    <tr>
                                        <td><div class="icheckbox_square-green" style="position: relative;"><input type="checkbox" name="inputpoiid[<?php echo $svv['id']?>]" value="<?php echo $svv['poi_id']?>" class="i-checks"><ins class="iCheck-helper"></ins></div></td>
          ...
          <div class="tool_bar border tc">
			<button id="sub_add_card" class="btn btn-primary" style="height: 36px;"> 提交审核 </button>
