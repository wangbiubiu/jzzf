					...
					<div class="col-lg-12">
						<div class="ibox float-e-margins">
							<div class="ibox-title clearfix">
								<ul class="nav">
									<li>
										<a href="?m=User&c=manager&a=ClerkAdd"><button class="btn btn-primary" id="pop_add_shop"><i class="fa fa-plus"></i> 添加店员</button></a>
									</li>
							...
							<div class="ibox-content">
								...
								<div class="app__content js-app-main page-cashier">
									<div>
										...
										<form action="/merchants.php?m=User&c=manager&a=StaffManagement" method="post">
											<div class="realtime-title-block clearfix md_xinxi">
												<label>店员名称<input type="text" value="<?php if(isset($getdata['username'])) echo $getdata['username'];?>" name="username" placeholder="输入店员名称"></label>
												...
												<div class="ui-box">
													<table class="ui-table ui-table-list" data-page-size="20" style="padding: 0px;">
														...
														<tbody class="js-list-body-region" id="table-list-body">
															<?php
															if (!empty($employee)) {
															foreach ($employee as $ovv) {
															?>
															<tr class="widget-list-item">
																<td><?php echo $ovv['eid'];?></td>
																<td><?php echo $ovv['username'];?></td>
																<td><?php echo $ovv['phone'].' '.$ovv['branch_name'];?></td>
																<td>
                                                                    <a class="btn btn-sm btn-info" href="?m=User&c=manager&a=ClerkUpdate&id=<?php echo $ovv['eid'];?>" style="vertical-align: top; background: #337ab7;"> 设置 </a>
																</td>
															</tr>
															<?php }}else{?>
															<tr class="widget-list-item">
																<td colspan="9">暂无店员</td>
															</tr>
															<?php }?>
														</tbody>
													</table>
