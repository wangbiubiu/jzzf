...
<div style="position: fixed;width: 85%;height: 1000px;background-color: #fefefe;top: 0;left:-85%;z-index: 4;box-shadow: 0 0 5px #eee;" id="sx">
    ...
    <div style="padding: 10px;">
        <form method="post" action="/merchants.php?m=User&c=manager&a=ShopownerCount">
            <div>支付方式</div>
...
<div style="padding: 10px;border-bottom: 1px solid #efefef;">
    <form method="get" action="/merchants.php?m=User&c=manager&a=ShopownerCount">
        <input type="hidden" value="User" name="m" >
        <input type="hidden" value="manager" name="c" >
        <input type="hidden" value="ShopownerCount" name="a" >
