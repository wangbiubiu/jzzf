                                ...
                                <form method="get" action="/merchants.php?m=User&c=manager&a=ShopownerCount">
                                    ...
                                    <div id="dataselect" class="form-group" style="padding: 0 10px;">
                                        <div id="datepicker" class="input-daterange">
                                            ...
                                            <input type="text" value="<?php if(isset($getdata['start'])){echo $getdata['start'];}else{echo date('Y-m-d',time());};?>" name="start" class="input-sm form-control" id="datestart" placeholder="开始时间" style=" margin-bottom: 0px; width: 120px; height: 30px; border-radius: 3px">
                                            &nbsp;<span> 到 </span>&nbsp;
                                            <input type="text" value="<?php if(isset($getdata['end'])){echo $getdata['end'];}else{echo date('Y-m-d',time());};?>" name="end" class="input-sm form-control" id="dateend" placeholder="结束时间" style=" margin-bottom: 0px; width: 120px; height: 30px; border-radius: 3px">
...
<form action="/merchants.php?m=User&c=manager&a=exportExcelwner" method="post" id="exportExcelwner">
