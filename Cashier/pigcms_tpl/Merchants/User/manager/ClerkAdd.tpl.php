                    ...
                    <div class="ibox float-e-margins">
                    	...
                    	<div class="ibox-content" style="border-top:none;">
                    		  ...
                    		  <div class="panel-body" style="padding: 0px; ">
                                ...
                                <form action="/merchants.php?m=User&c=manager&a=ClerkAdd" id="ClerkAdd" method ="post" class="form-horizontal form-border jbxi_bg clearfix" style="width: 80%; margin: 0 auto 60px; position: relative; border: 1px solid #EEEEEE;">
                                	<h4 class="tit_h4"><span>添加店员</span></h4>
                                    <div class="form-group clearfix">
                                        <label class="control-label">员工姓名</label>
                                        <div >
                                            <input type="text" class="form-control" placeholder="如：张三" name="username">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group clearfix">
                                        ...
                                        <div>
                                            <input type="text" class="form-control" name="account" placeholder="建议使用邮箱">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group clearfix">
                                        ...
                                        <div>
                                            <label><input type="checkbox" id="shoukuan" name="jurisdiction" value="1">有</label>
                                        </div>
                                        <div class="shoukuan" style="display:none ; margin-left: 120px;">
                                            <label><input type="text" name="qrcodeid"  placeholder="输入收款二维码ID"></label><br />
                                        </div>
                                    </div>
...
function ClerkAdd(){
	var username = $('input[name="username"]').val();
  	...
  	if(account == ''){
  	  	swal({title: "错误",text: "请填写用户名",type: "error"});
  	  	return false;
	}
	...
	if(!tel.exec(phone)){
  	...
  	if($('#shoukuan').is(':checked')){
  	  	var qrcodeid = $('input[name="qrcodeid"]').val();
  	  	if(qrcodeid == ''){
  	  	  	swal({title: "错误",text: "请输入收款二维码",type: "error"});
  	  	  	return false;
  	  	}
  	}
  	$('#ClerkAdd').submit();
