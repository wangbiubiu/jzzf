...
<div style="position: fixed;width: 85%;height: 1000px;background-color: #fefefe;top: 0;left:-85%;z-index: 4;box-shadow: 0 0 5px #eee;" id="sx">
    ...
    <div style="padding: 10px;">
        <form method="get" action="/merchants.php?m=User&c=count&a=storesdetail">
...
<!--    <a href="javascript:;" onclick="$('#bg').fadeIn();$('#sx').animate({left:'0%'});" style="color:#333;padding:0 20px 0 10px;display: block;float:left;">筛选</a>-->
    <a href="/merchants.php?m=User&c=index&a=sindex" onclick="" style="padding:0 20px 0 10px;display: block;float:left;color:#fff;">< 返回</a>
    <a href="/merchants.php?m=User&c=count&a=store" onclick="" style="color:#fff;padding:0 10px 0 20px;display: block;float:right;"><?php echo $storname; ?></a>
</div>
