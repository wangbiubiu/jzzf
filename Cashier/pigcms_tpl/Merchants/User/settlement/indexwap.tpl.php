...
<div style="padding:15px 10px;border-bottom: 1px solid #efefef;">
    <div style="width: 49%;float:left;text-align: center;border-right: 1px solid #efefef;">
        <div style="margin-bottom: 5px;font-size: 24px;color:#008fd3;">
            <?php if(!empty($money)){echo sprintf("%.2f",$money);}else{echo "0.00";} ?>
        </div>
        <div style="color:#999;">昨日结算（元）</div>
    </div>
    <div style="width: 49%;float:right;text-align: center;">
        <div style="margin-bottom: 5px;font-size: 24px;color:#008fd3;"><?php echo sprintf("%.2f",$money2);?></div>
        <div style="color:#999;">今日收款（元）</div>
    </div>
    <div style="clear: both;"></div>
</div>
<div style="padding: 10px;border-bottom: 1px solid #efefef;">
    <form method="get" action="/merchants.php?m=User&c=settlement&a=index">
