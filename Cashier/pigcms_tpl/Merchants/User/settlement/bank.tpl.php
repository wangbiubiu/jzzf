        ...
        <div class="row wrapper page-heading iconList" >
            <div class="bankCardInfor">
                ...
                <?php if(!empty($bank) && ($bank['bank'] == 0 || $bank['bank'] == 1)){?>
                    ...
                    <form id="form1" method="post" enctype="multipart/form-data" action="merchants.php?m=User&c=settlement&a=bank">
                        <!--显示页-->
                        ...
                        <?php if($bank['isCompay'] == 1){ ?>
                            <div>
                                <label>开户行号：</label>
                                <?php echo $bank['accBankNo'];?>
                            </div>
                        <?php }else{ ?>
                    ...
                    <?php if($bank['bank'] == 1){?>
                        <form id="form2" style="display: none;" method="post" action="merchants.php?m=User&c=settlement&a=bank" enctype="multipart/form-data">
                        	<!--修改页-->
                            ...
                            <div>
                                <label id="addyyzzhm"><i>*</i>证件号码：</label>
                      ...
                      <!--start新增上传  添加7.10-->
                       <div class="clearfix" id="Realestate" >
                            ...
                            <div style="width: 100px; height:100px; margin-left:265px; margin-bottom: 10px; background-color: #f6f6f6;" class="sfz1img"></div>
								<div style="float:left ;margin-left: 112px;" id="addsfzzm">上传身份证正面图片:</div>
						...
						<div class="clearfix" id="addsfzfm">
							...
							<div class="clearfix" id="addscsfzfm">
							...
							<div>
                                <label id="addckrxm"><i>*</i>持卡人姓名：</label>
                            ...
                            <div id="addqshh">
                                ...
                                <select name="settBankNo2">
                                    <option value="102100099996" <?php if(!empty($bank) && $bank['settBankNo2'] == "102100099996"){echo 'selected="selected"';} ?>>工商银行</option>
                                    <option value="103100000026" <?php if(!empty($bank) && $bank['settBankNo2'] == "103100000026"){echo 'selected="selected"';} ?>>农业银行</option>
                                    <option value="104100000004" <?php if(!empty($bank) && $bank['settBankNo2'] == "104100000004"){echo 'selected="selected"';} ?>>中国银行</option>
                                    <option value="105100000017" <?php if(!empty($bank) && $bank['settBankNo2'] == "105100000017"){echo 'selected="selected"';} ?>>建设银行</option>
                                    <option value="301290000007" <?php if(!empty($bank) && $bank['settBankNo2'] == "301290000007"){echo 'selected="selected"';} ?>>交通银行</option>
                                    <option value="302100011000" <?php if(!empty($bank) && $bank['settBankNo2'] == "302100011000"){echo 'selected="selected"';} ?>>中信银行</option>
                                    <option value="303100000006" <?php if(!empty($bank) && $bank['settBankNo2'] == "303100000006"){echo 'selected="selected"';} ?>>光大银行</option>
                                    <option value="304100040000" <?php if(!empty($bank) && $bank['settBankNo2'] == "304100040000"){echo 'selected="selected"';} ?>>华夏银行</option>
                                    <option value="305100000013" <?php if(!empty($bank) && $bank['settBankNo2'] == "305100000013"){echo 'selected="selected"';} ?>>民生银行</option>
                                    <option value="306581000003" <?php if(!empty($bank) && $bank['settBankNo2'] == "306581000003"){echo 'selected="selected"';} ?>>广发银行</option>
                                    <option value="307584007998" <?php if(!empty($bank) && $bank['settBankNo2'] == "307584007998"){echo 'selected="selected"';} ?>>平安银行</option>
                                    <option value="308584000013" <?php if(!empty($bank) && $bank['settBankNo2'] == "308584000013"){echo 'selected="selected"';} ?>>招商银行</option>
                                    <option value="309391000011" <?php if(!empty($bank) && $bank['settBankNo2'] == "309391000011"){echo 'selected="selected"';} ?>>兴业银行</option>
                                    <option value="313100000013" <?php if(!empty($bank) && $bank['settBankNo2'] == "313100000013"){echo 'selected="selected"';} ?>>北京银行</option>
                                    <option value="325290000012" <?php if(!empty($bank) && $bank['settBankNo2'] == "325290000012"){echo 'selected="selected"';} ?>>上海银行</option>
                                    <option value="310290000013" <?php if(!empty($bank) && $bank['settBankNo2'] == "310290000013"){echo 'selected="selected"';} ?>>上海浦东发展银行</option>
                                    <option value="403100000004" <?php if(!empty($bank) && $bank['settBankNo2'] == "403100000004"){echo 'selected="selected"';} ?>>中国邮政储蓄银行</option>
                                </select>
                                <i>只支持以上银行</i>
                            </div>
						...
						<div class="clearfix" id="Realestate" >
                            ...
                            <div style="width: 100px; height:100px; margin-left:165px; margin-bottom: 10px; background-color: #f6f6f6;" class="sfz4img"></div>
								<label style="float:left ;margin-left: 1%;" id="addyhkzm">上传银行卡正面图片:</label>
								<div style="float:left ;">
									<div id="js_upload_wrp">
									   <div class="img_upload_wrp group"> 
											<div class="img_upload_box"> 
							...
							<div class="clearfix" id="addyhkfm">
