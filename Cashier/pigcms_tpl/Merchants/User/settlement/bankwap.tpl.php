    ...
    <form method="post" class="editbank" style="display: none;" enctype="multipart/form-data">
								...
								<div style="float:left ;">
									<div id="js_upload_wrp">
									   <div class="img_upload_wrp group"> 
											<div class="img_upload_box dz-image-preview"> 
                                                <div style="float: left;"><a class="a_button alert-btn2" href="javascript:">样式</a></div> 
												<div style="float: left; margin-left: 10px;"><a class="img_upload_box_oper js_upload js_pic_url a_button" id ='constructLeanID' href="javascript:">上传附件</a> </div>
											</div>
											<div class="js_pager">
								...
								<div style="float:left ;">
									<div id="js_upload_wrp">
									   <div class="img_upload_wrp group"> 
                                            ...
                                            <div style="float: left;"><a class="a_button alert-btn2" href="javascript:">样式</a> </div>
												 <div style="float: left; margin-left: 10px;"><a class="img_upload_box_oper js_upload js_pic_url a_button" id ='constructLean' href="javascript:"> 上传文件 </a> </div>
											</div>
											<div class="js_pager">
								...
								<div style="float:left ;">
									...
									<div id="js_upload_wrp">
									   <div class="img_upload_wrp group"> 
											<div class="img_upload_box"> 
                                            <div style="float: left;"><a class="a_button alert-btn2" href="javascript:">样式</a> </div>
												 <div style="float: left; margin-left: 10px;"><a class="img_upload_box_oper js_upload js_pic_url a_button" id='contact' href="javascript:">上传文件</a> </div>
											</div>
											<div class="js_pager">
        ...
        <div class="clearfix" id="Realestate" >
							<div class="clearfix" style="margin-top: 10px;">
								<label style="float:left ;margin-left: 5%; margin-top: 10px;">上传银行卡正面图片:</label>
								<div style="float:left ;">
									<div id="js_upload_wrp">
									   <div class="img_upload_wrp group"> 
											<div class="img_upload_box"> 
												 <a class="img_upload_box_oper js_upload js_pic_url a_button" id='cunstructID'  href="javascript:"> 上传文件</a> 
											</div>
											<div class="js_pager">
							...
							<div class="clearfix" style="margin-top: 10px">
								...
								<div style="float:left ;">
									<div id="js_upload_wrp">
									   <div class="img_upload_wrp group"> 
											<div class="img_upload_box"> 
												 <a class="img_upload_box_oper js_upload js_pic_url a_button" id='landUseId' href="javascript:"> 上传文件</a> 
											</div>
											<div class="js_pager">
    ...
    <div>
        <form method="post" action="merchants.php?m=User&c=settlement&a=bank" enctype="multipart/form-data">
            ...
            <!--start新增上传  添加7.10-->
								...
								<div style="float:left ;">
									<div id="js_upload_wrp">
									   <div class="img_upload_wrp group"> 
											<div class="img_upload_box"> 
                                            <div style="float: left;"><a class="a_button alert-btn2" href="javascript:">样式</a></div> 
												 <div style="float: left; margin-left: 10px;"><a class="img_upload_box_oper js_upload js_pic_url a_button" id ='constructLeanID' href="javascript:">  上传文件</a> </div>
											</div>
			 ...
			 <div style="padding: 0 10px;height: 50px;line-height: 50px;border-bottom: 1px solid #f5f5f5;background-color: #fff;">
                <div style="float:left;float: 10px;text-align: right;">
                    持卡人手机号：
                </div>
                <div style="float:left;margin-right: 5%;">
                    <input type="text" name="phoneNo" value="<?php echo $bank['phoneNo'];?>" placeholder="选填" <?php if(!empty($bank) && $bank['bank'] == 0){echo 'readonly="readonly"';} ?>>
            ...
            <div class="clearfix" id="Realestate" >
							<div class="clearfix">
								<label style="margin-left: 5%;line-height: 48px;">上传银行卡正面图片:</label>
								<div style="">
									<div id="js_upload_wrp">
									   <div class="img_upload_wrp group"> 
											<div class="img_upload_box"> 
							...
							<div class="clearfix">
								<label style="margin-left: 5%;line-height: 48px;">上传银行卡背面图片:</label>
...
<?php } ?>
<div>
    <a href="" id="ll">上传文件1111</a>
    <input id="up" type="file" class="hidden" name="">
</div>
...
//  });
  ...
  <script src="/Cashier/pigcms_static/plugins/js/dropzone.js"></script>
    <!-- iCheck -->
...
<script>	
 $(function(){
     ...
     $(".js_pic_url,.js_pic_url .icon20_common add_gray").dropzone({
        ...
        previewTemplate:'<div class=dz-image style=\"margin-left:25px;margin-bottom:10px;\"><img data-dz-thumbnail width=100px height=100px style=\"border:1px solid #ccc;margin-left:50px;\" /></div>',
		init: function() {
			this.on("success", function(file,responseText) {
                var df= $(file.previewTemplate);
...
//				}
				...
				$(this.element).parents(".img_upload_box").siblings().html(df);
			});
		}
	});
...
$(document).delegate(".alert-btn2",'click',function(){
        ...
        M.dialog2 = jqueryAlert({
            'content' : '<img src="./Cashier/pigcms_static/image/model1.jpg" width="220" height="140"><br><img src="./Cashier/pigcms_static/image/model2.jpg" width="220" height="140"><br><br><img src="./Cashier/pigcms_static/image/model3.jpg" width="220" height="140">',
            'modal'   : true,
            'buttons' :{
                '确定' : function(){
                    M.dialog2.close();
