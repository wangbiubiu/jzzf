									...
									<div>
										...
										<div class="cashier-realtime">
											<div class="realtime-title-block clearfix md_xinxi">
												<label>业务员名称<input type="text" placeholder="输入门店名称"></label>
													...
													<table class="ui-table ui-table-list" data-page-size="20" style="padding: 0px; text-align: center;">
														...
														<tbody class="js-list-body-region" id="table-list-body">
															...
															<tr class="widget-list-item">
																...
																<td>13320212122</td>
																<td>
                                                                    <a class="btn btn-sm btn-info" href="#" style="vertical-align: top; background: #337ab7;"> 管理 </a>
																	<a class="btn btn-sm btn-info" href="#" style="vertical-align: top;"> 进入管理 </a>
...
function DelStore(storeId){
	swal({
		title: "删除门店业务员",   
		text: "此门店业务员尚未审核通过，您确定要删除吗？\n此时删除将无法同步删除微信公众后台此业务员。",
		type: "warning",   
		showCancelButton: true,   
		confirmButtonText: "删除",   
		cancelButtonText: "取消",   
