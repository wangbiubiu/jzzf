				...
				<div class="row role_permission" style="position: relative; padding-bottom: 50px;">
					...
					<div>
						...
						<div class="clearfix">
							...
							<div>
								<input id="account_ID" type="text" placeholder="">
								<p class="ts"></p>
						...
						<div class="clearfix">
							...
							<div>
								<input id="open_bank" type="text" placeholder="">
								<p class="ts"></p>
								<p>填写开户银行</p>
							</div>
						</div>
						...
						<div class="clearfix">
							...
							<div>
								<input id="bank_city" type="text" placeholder="">
								<p class="ts"></p>
								<p>填写开户银行所在城市</p>
							</div>
						</div>
						...
						<div class="clearfix">
							...
							<div>
								<input id="bank_account" type="text" placeholder="" onkeyup="this.value=this.value.replace(/\D/g,'')">
								<p class="ts"></p>
								<p>请填写企业的对公银行账号</p>
							</div>
						</div>
					...
					<p class="tj"><input  type="submit"  value="保存并下一步"/><button><a  href="#"> 上一步</a></button></p>
	            </div>
			</div>
