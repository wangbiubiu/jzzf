                    ...
                    <div class="ibox float-e-margins">
                    	...
                    	<div class="ibox-content" style="border-top:none;">
                    		  ...
                    		  <div class="panel-body" style="padding: 0px; ">
                                      <form action='?m=User&c=merchant&a=addstore' method="post" class="form-horizontal form-border jbxi_bg clearfix" style="width: 80%; margin: 0 auto 60px; position: relative; border: 1px solid #EEEEEE;">
                                	<h4 class="tit_h4"><span>添加店员</span></h4>
                                    <div class="form-group clearfix">
                                        <label class="control-label">员工姓名</label>
                                        <div >
                                            <input type="hidden" name="sid" value="<?php echo $sid ;?>" >
                                            <input type="text" name="username" class="form-control" placeholder="如：张三" >
                                        </div>
                                    </div>
                                    <div class="form-group clearfix">
                                        <label class=" control-label">用户级别</label>
                                        <div>
                                            <label><input type="radio"  name="level" value="1">店长</label>
                                            <label><input type="radio"  name="level" checked="checked" value="0">店员</label>
                                        </div>
                                    </div>
                                    <div class="form-group clearfix">
                                        <label class=" control-label">登录帐号</label>
                                        <div>
                                            <input type="text" name="account" class="form-control" placeholder="建议使用邮箱">
                                        </div>
                                    </div>
                                    <div class="form-group clearfix">
                                        <label class=" control-label">密码</label>
                                        <div>
                                          <input type="text" name='password' class="form-control" placeholder="输入密码">
                                        </div>
                                    </div>
                                    <div class="form-group clearfix">
                                        <label class=" control-label">收款权限</label>
                                        <div>
                                            <label><input type="checkbox" id="shoukuan" name="is_receivables" value="1">有</label>
                                        </div>
                                        <div class="shoukuan" style="display:none ; margin-left: 120px;">
                                            <label><input type="text" style="width:250px;" name="ewm" placeholder="输入收款二维码ID"></label><br />
                                        </div>
                                    </div>
                                          ...
                                          <div class="form-group clearfix">
                                              ...
                                              <div>
                                                  <label><input type="checkbox" id="print" name="is_print" value="1">有</label>
                                              </div>
                                              <div class="print" style="display:none ; margin-left: 120px;">
                                                  <label><input type="text" style="width:250px;" name="print_id" placeholder="输入打印机ID"></label><br />
                                              </div>
                                          </div>
                                    ...
                                    <div class="form-group clearfix">
                                        ...
                                        <div>
                                            <label><input type="checkbox" name="is_refund" value="1">有</label>
                                        </div>
                                    </div>
