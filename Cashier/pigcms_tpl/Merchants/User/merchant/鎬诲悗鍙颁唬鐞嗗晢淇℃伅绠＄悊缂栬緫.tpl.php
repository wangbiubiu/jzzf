                    		  ...
                    		  <div class="panel-body" style="padding: 0px; ">
                                <form class="form-horizontal form-border jbxi_bg clearfix" style="width: 95%; margin: 0 auto 60px; position: relative; border: 1px solid #EEEEEE;">
                                    ...
                                    <div class="form-group clearfix">
                                        ...
                                        <div>
                                            <input type="text" class="form-control" placeholder="输入代理商名称">
                                        </div>
                                    </div>
                                    <div class="form-group clearfix">
                                    ...
                                    <div class="form-group clearfix">
                                        <label class=" control-label">修改密码</label><input type="checkbox" id="xuanzhe" style="margin-top: 13px;"/>
                                        <div class="mima" style="display: none; margin-left: 50px;">
                                            <label>新密码<input type="text" placeholder="输入新密码"></label><br />
                                            <label>新密码<input type="text" placeholder="输入新密码"></label>
                                        </div>
                                    </div>
                                     <div class="form-group clearfix">
                                        <label class="control-label">佣金返点</label>
                                        <div>
                                    ...
                                    <div class="form-group clearfix">
                                        ...
                                        <div>
                                           <input type="text" class="form-control" placeholder="服务热线">
                                        </div>
                                    </div>
