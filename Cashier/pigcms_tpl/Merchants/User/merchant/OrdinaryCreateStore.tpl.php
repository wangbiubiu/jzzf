                        ...
                        <div class="ibox-content">
                            <div class="group main_bd">
                                <form novalidate="novalidate" class="store_build" id="js_store_build">
                                    <div class="frm_section">
                                                ...
                                                <div class="frm_controls input_controls" style="margin:15px 0 0 5px">
                                                    <div  class="frm_control_group">
                                                        <label for="" class="frm_label">详细地址</label>
                                                                <span class="frm_input_box"> <input placeholder="输入详细地址，请勿重复填写省市区信息" name="address" id="searchSubmit" class="frm_input" type="text" />
                                                                </span>


                                                        经纬度：<input name="latitude" id="js_latitude" type="text" class="form-control" placeholder="纬度，点击地图获取"/>&nbsp;
                                                        <input name="longitude" id="js_longitude" type="text" class="form-control" placeholder="经度，点击地图获取"/>
                                        ...
                                        <div class="frm_control_group" id="js_mark_position" >
                                            ...
                                            <div class="frm_controls" id="mapfrm_controls">
                                                ...
                                                <div class="map_panel" style="display: table;">

                                                    <div id="bside_left"><div> <p>在搜索框搜索关键词后，地图上会显示相应poi点，同时左侧显示对应该点的信息，点击某点或某信息，右上角会显示相应该点的坐标和地址。</p></div></div>

                                                    <div class="map crosspoint map_result" id="mapcontainer" style="display: table-cell;">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="frm_control_group">
                                        <label for="" class="frm_label">店长姓名
                                            <br >
                                            <span style="font-weight:bold;color:red;"></span></label>
                                        <div class="frm_controls">
                                            <span class="frm_input_box"> <input class="frm_input" id="username" name="username" type="text" maxlength="16"/> </span>
                                        </div>
                                    </div>
                                    <div class="frm_control_group">
                                        <label for="" class="frm_label">店长账号
                                            <br >
                                            <span style="font-weight:bold;color:red;"></span></label>
                                        <div class="frm_controls">
                                            <span class="frm_input_box"> <input class="frm_input" id="account" name="account" type="text" style="ime-mode: disabled;"/> </span>
                                        </div>
                                    </div>
                                    <div class="frm_control_group">
                                        <label for="" class="frm_label">店长密码
                                            <br >
                                            <span style="font-weight:bold;color:red;"></span></label>
                                        <div class="frm_controls">
                                            <span class="frm_input_box"> <input class="frm_input" id="password" name="password" type="text"/> </span>
                                        </div>
                                    </div>

                                    <div class="frm_control_group">
                                        <label class="frm_label">门店类型</label>
                                        <div>
                                            普通店铺<input type="radio" checked name="status" value="0" id="mtypes"  style="margin-top: 5px;"> &ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;
                                            加盟店<input type="radio" value="1" id="mtype" name="status">
                                        </div>
                                    </div>

                                    <div class="frm_control_group fws" style="display:none;" >
                                        <div class="frm_controls">
                                            <label class="frm_label">银行卡号</label>
                                            <span class="frm_input_box"> <input class="frm_input" name="bank" id="js_telephone" type="text" onkeyup="value = value.replace(/[^1234567890\-]+/g, '')" maxlength="25"/> </span>
                                        </div>
                                    </div>
