                                ...
                                <div class="ibox-content" style="border-top:none;">
                                    ...
                                    <div class="panel-body" style="padding: 0px; ">
                                        <div class="form-horizontal form-border jbxi_bg" style="width: 100%; margin: 0 auto; border: 1px solid #EEEEEE;">
                                            <h4 class="tit_h4"><span>店员基本信息</span><a style="float: right;" href="/merchants.php?m=User&c=merchant&a=assistantedito&eid=<?php echo $eid; ?>">编辑</a></h4>
                                ...
                                <div class="ibox-content yc" style="border-top:none">
                                    ...
                                    <div  class="employersDelAll" >
                                        <table class="footable table table-stripped toggle-arrow-tiny" data-page-size="10" data-filter=#filter style="margin-bottom: 0px;">
                                            <thead>
                                                <tr>
                                                    <th style="text-align: center;"  data-hide="phone">收款二维码ID</th>
                                                    <th  style="text-align: center;">收银员头像</th>
                                                    <th style="text-align: center;" data-hide="phone">收银员昵称</th>
                                                    <th style="text-align: center;" data-hide="phone">通知二维码</th>
                                                </tr>
                                            </thead>
                                                ...
                                                <?php if($qr){
                                                    foreach($qr as $q){?>
                                                        <tr class="widget-list-item bd_nr" style="text-align: center;">
                                                            <td><?php echo $q['qrcode_id'] ?></td>

                                                            <?php if($q['xw_img']){?>
                                                                <td><img src="<?php echo $q['xw_img']?>" style="width: 40px; height: 40px;border-radius: 50%;"></td>
                                                            <?php }else{?>
                                                                <td>未绑定通知二维码</td>
                                                            <?php }?>
                                                            ...
                                                            <td>
                                                                <?php if($q['openid']){?>
                                                                    <p>
                                                                        <button class="btn btn-sm btn-info" style="background: #AA00AA;border: none;">解绑</button>
                                                                    </p>
                                                                <?php }else{?>
                                                                    <p>未绑定</p>
                                                                <?php }?>
                                        ...
                                        <p class="sl"><span>成交笔数:<?php echo $count ?></span><span>成交金额：<?php echo $money?></span></p>
                                    </div>
                                </div>
...
<script>
    $('.btn').click(function(){
        ...
        swal({
            ...
            if(isConfirm){
            $.post('?m=User&c=merchant&a=assistant',{eid:eid},function(re){
