                                ...
                                <form novalidate="novalidate" class="store_build" id="js_store_build">
                                    ...
                                    <div class="frm_control_group">
                                        <label for="" class="frm_label">店长密码
                                            ...
                                            <span style="font-weight:bold;color:red;"></span></label>
                                        <div class="frm_controls">
                                            <input  id="status"  name="status" checked="checked" value="0" type="radio">普通门店
                                            <input  id="status" name="status" value="1"  type="radio">加盟门店
                                        </div>
                                    </div>
                                    <div class="frm_control_group">
                                        <label for="" class="frm_label">银行卡号
                                            <br >
                                            <span style="font-weight:bold;color:red;"></span></label>
                                        <div class="frm_controls">
                                            <span class="frm_input_box"> <input class="frm_input" id="userbank"  name="bank" type="text"/> </span>
                                        </div>
                                    </div>
                            </div>
