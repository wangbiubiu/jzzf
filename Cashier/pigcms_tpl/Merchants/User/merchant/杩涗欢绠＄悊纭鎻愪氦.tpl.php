...
.tj{ width: 250px; margin: 0 auto;}
.tj>input{ background: #2f9833; width: 100px; height: 30px; line-height: 30px; color: #FFFFFF; border: none; border-radius: 2px;  margin-right: 20px;}
.tj>button{ border: 1px solid #f2f2f2; width:100px; height: 31px; line-height: 31px; background: #FFFFFF;border-radius: 2px;}
span{color: #AAAAAA;}
</style>
	...
	<?php include RL_PIGCMS_TPL_PATH.APP_NAME.'/'.ROUTE_MODEL.'/public/top.tpl.php';?>
            <div class="row wrapper border-bottom white-bg page-heading">
				<div class="col-lg-10">
					...
					<ol class="breadcrumb">
						...
						<li><a>商户中心</a></li>
						<li><a>进件管理</a></li>
						<li class="active"><strong>确认提交</strong></li>
					</ol>
				</div>
			...
			<div class="wrapper wrapper-content animated fadeInRight">
				<div class="row role_permission" style="position: relative; padding-bottom: 50px;">
                    ...
                    -->
					<div>
						<h2>联系信息<a style="float: right; padding-right: 10px;" href="#">修改</a></h2>
					...
					<div class="select_permissions ">
						<h2>经营信息<a style="float: right; padding-right: 10px;" href="#">修改</a></h2>
                    ...
                    -->
					<div class="select_permissions ">
						<h2>商户信息<a style="float: right; padding-right: 10px;" href="#">修改</a></h2>
						<div>
							<h3>基本信息</h3>
                    ...
                    -->
					<div class="select_permissions ">
						<h2>结算信息<a style="float: right; padding-right: 10px;" href="#">修改</a></h2>
					...
					<p class="tj"><input type="submit"  value="确认提交"/><button><a href="#">上一步</a></button></p>
	            </div>
			</div>
