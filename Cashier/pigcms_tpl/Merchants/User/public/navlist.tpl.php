				<style type="text/css">
                 ...
                 <div class="col-lg-12 dh_nav">
                	<ul>
                		<dl>
	                		<a href="/merchants.php?m=User&c=staff&a=payment&type=1">
	                			<dd>
                		...
                		<dl>
                			<a href="/merchants.php?m=User&c=staff&a=payment&type=2">
	                			<dd>
...
<!--                 		<dl>
                		...
                		<dl>
                		<a href="/merchants.php?m=User&c=staff&a=orderLists">
                			<dd>
                			<i class="imgmxz"><img src="./Cashier/pigcms_static/image/<?php if (ROUTE_ACTION==='orderLists') echo 3;?>3.png"></i>
                			</dd>
                			<dt>收款记录</dt>
                		</a>
                		</dl>
                		...
                		<dl>
                			<a href="/merchants.php?m=User&c=staff&a=consumeCard">
	                			<dd>
	                			<i class="imgmxz"><img src="./Cashier/pigcms_static/image/<?php if (ROUTE_CONTROL==='staff'&& ROUTE_ACTION==='consumeCard') echo 5;?>5.png"></i>
