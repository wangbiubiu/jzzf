                    	...
                    	<div class="ibox-content" style="border-top:none;">
                    		  <div class="panel-body" style="padding: 0px; ">
                                <div class="form-horizontal form-border jbxi_bg" style="width: 100%; margin: 0 auto; border: 1px solid #EEEEEE;">
                                	<h4 class="tit_h4"><span>基本信息</span><a style="float: right;" href="/merchants.php?m=System&c=agent&a=edit&aid={pg:$row.aid}">编辑</a></h4>
                                    ...
                                    {pg:if $row.commission>0}
                                        <div class="form-group clearfix">
                                            <label >特约商户</label>
                                            <p><b>微信结算价:</b> {pg:$row.commission*100}% &ensp;&ensp;&ensp;&ensp;&ensp; <b>支付宝结算价:</b>{pg:$row.alicommission*100}%</p>
    
                                        </div>
                                    {pg:/if}
                                    {pg:if $row.ancommission>0}
                                        <div class="form-group clearfix">
                                            <label >银行直连</label>
                                            <p><b>微信结算价:</b> {pg:$row.ancommission*100}% &ensp;&ensp;&ensp;&ensp;&ensp; <b>支付宝结算价:</b>{pg:$row.analicommission*100}%</p>
    
                                        </div>
                                    {pg:/if}
                                    {pg:if $row.wxcommission>0}
                                        <div class="form-group clearfix">
                                            <label >金海哲</label>
                                            <p><b>微信结算价:</b> {pg:$row.wxcommission*100}% &ensp;&ensp;&ensp;&ensp;&ensp; <b>qq结算价:</b>{pg:$row.qqcommission*100}%</p>
...
<!--                                    <div class="form-group clearfix">
                                        <label >一清支付宝佣金</label>
                                        <p>{pg:$row.alicommission*100}%</p>
                                    </div>
                                    <div class="form-group clearfix">
                                        <label >二清微信佣金</label>
                                        <p>{pg:$row.ancommission*100}%</p>
                                    </div>
                                    <div class="form-group clearfix">
                                        <label >二清支付宝佣金</label>
                                        <p>{pg:$row.analicommission*100}%</p>
                                    </div>    -->
                                    <div class="form-group clearfix">
                                        <label>联系人</label>
                                        <p>{pg:$row.contacts}</p>
                                    ...
                                    <div class="form-group clearfix">
                                        <label>公司名称</label>
                                        <p>{pg:$row.corporate}</p>
                                    </div>
                                    <div class="form-group clearfix">
                                        <label>公司地址</label>
                                        <p>{pg:$row.provincename}{pg:$row.cityname}{pg:$row.countyname}{pg:$row.address}</p>
                                    </div>
                                </div>
