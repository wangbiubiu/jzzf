                    ...
                    <div class="row">
                        <div class="tit">
                            <ul class="clearfix " style="margin-bottom: 0px; padding-left: 16px;">
                               <li {pg:if $type==1} class="cont" {pg:/if}> <a href="/merchants.php?m=System&c=settlement&a=aset">待划账</a></li>
                                <li {pg:if $type==2} class="cont" {pg:/if}><a href="/merchants.php?m=System&c=settlement&a=adebit">已划账</a></li>
                                        ...
                                        <table class="footable table table-stripped toggle-arrow-tiny" data-page-size="10" data-filter=#filter>
                                            ...
                                            <tbody class="js-list-body-region" id="table-list-body">
                                                ...
                                                <tr class="widget-list-item bd_nr" style="text-align: center;">
                                                    ...
                                                    <td>{pg:$v.addtime}</td>
                                                    <td>{pg:$v.count_turnover}</td>
                                                    <td>{pg:$v.count_deposit}</td>
                                                    <td>
                                                        <p>
                                                            {pg: if ($v.status == "4")}
                                                            <button class="btn btn-sm btn-info alert-btn5" data-id="{pg:$v.id}" data-money="{pg:$v.count_deposit}"  style="background: #008fd3;">划账</button>
                                                            <a href="/merchants.php?m=System&c=settlement&a=aedit&id={pg:$v.id}"><button class="btn btn-sm btn-info" style="background: #008fd3;">修改</button>
                                                            {pg: /if}
                                                        </p>
                                                    </td>
