            ...
            <div class="row payment_allocation">
                ...
                <div>
                    <form action="merchants.php?m=System&c=settlement&a=settx" method="post">
                        ...
                        <div>
                            <label>商户ID</label>
                            <input type="text" id="or"  placeholder="" value="{pg:$bank.mid}" readonly="readonly"/>
                        </div>
                        <div>
                            <label>商户名称</label>
                            <input type="text" id="or"  placeholder="" value="{pg:$bank.username}" readonly="readonly"/>
                        </div>
                        <div>
                            <label>收款金额</label>
                            <input type="text" id="or"  placeholder="" value="{pg:$bank.money2}" readonly="readonly"/>
                        </div>
                        <div>
                            <label>提现金额</label>
                            <input type="text" id="or"  placeholder="" value="{pg:$bank.money}" name="money"/>
