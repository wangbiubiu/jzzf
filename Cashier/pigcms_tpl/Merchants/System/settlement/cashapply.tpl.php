                                        ...
                                        <table class="footable table table-stripped toggle-arrow-tiny" data-page-size="10" data-filter=#filter style="margin-bottom: 0px;">
                                            ...
                                            <tbody class="js-list-body-region" id="table-list-body">
                                                ...
                                                <tr class="widget-list-item bd_nr" style="text-align: center;">
                                                    ...
                                                    <td>{pg:$vv.name}</td>
                                                    <td>
                                                        {pg: if ($vv.bank_name == "ICBC")}工商银行{pg:/if}
                                                        {pg: if ($vv.bank_name == "ABC")}农业银行{pg:/if}
                                                        {pg: if ($vv.bank_name == "BOC")}中国银行{pg:/if}
                                                        {pg: if ($vv.bank_name == "CCB")}建设银行{pg:/if}
                                                        {pg: if ($vv.bank_name == "CMB")}招商银行{pg:/if}
                                                        {pg: if ($vv.bank_name == "BOCM")}交通银行{pg:/if}
                                                        {pg: if ($vv.bank_name == "CMBC")}民生银行{pg:/if}
                                                        {pg: if ($vv.bank_name == "CNCB")}中信银行{pg:/if}
                                                        {pg: if ($vv.bank_name == "CEBB")}光大银行{pg:/if}
                                                        {pg: if ($vv.bank_name == "CIB")}兴业银行{pg:/if}
                                                        {pg: if ($vv.bank_name == "BOB")}北京银行{pg:/if}
                                                        {pg: if ($vv.bank_name == "GDB")}广发银行{pg:/if}
                                                        {pg: if ($vv.bank_name == "HXB")}华夏银行{pg:/if}
                                                        {pg: if ($vv.bank_name == "PAB")}平安银行{pg:/if}
                                                        {pg: if ($vv.bank_name == "BOS")}上海银行{pg:/if}
                                                        {pg: if ($vv.bank_name == "BOHC")}渤海银行{pg:/if}
                                                        {pg: if ($vv.bank_name == "BOJ")}江苏银行{pg:/if}
                                                        {pg: if ($vv.bank_name == "SPDB")}浦发银行{pg:/if}
                                                        {pg: if ($vv.bank_name == "PSBC")}邮储银行{pg:/if}
                                                        {pg: if ($vv.bank_name == "")}其他银行{pg:/if}
                                                    </td>
                                                    <td>{pg:$vv.addtime}</td>
                                                    <!--<td>{pg:$vv.money2}</td>-->
                                                    <td>{pg:$vv.money}</td>
