...
<html>
    <head>
        ...
        <link href="{pg:$smarty.const.RL_PIGCMS_STATIC_PATH}css/cashier.css" rel="stylesheet">
                                                ...
                                                <form action="" method="get" >
                                                    <div id="dataselect" class="form-group" style="padding: 0 10px;">
                                                        ...
                                                        <div id="datepicker" class="input-daterange">
                                                            ...
                                                            <input class="form-control" type="text" name="company" value="{pg: if (isset($getdata.company))}{pg: $getdata.company}{pg:/if}"  placeholder="输入商户名称" style="width: 20%;border-radius:5px;height: 40px; margin-bottom: 0px;">
                                                            <label class="font-noraml">选择日期</label>&nbsp;&nbsp;&nbsp;
                                                            <input type="text" value="{pg: if (isset($getdata.start))}{pg: $getdata.start}{pg:/if}" name="start" class="input-sm form-control" id="datestart" placeholder="开始时间" style=" height: 40px; margin-bottom: 0px; width: 20%;">
                                                            &nbsp;<span> 到 </span>&nbsp; 
                                                            <input type="text" value="{pg: if (isset($getdata.end))}{pg: $getdata.end}{pg:/if}" name="end" class="input-sm form-control" id="dateend" placeholder="结束时间" style=" height: 40px; margin-bottom: 0px; width: 20%;"> 
                                                    ...
                                                    <div class="ui-box">
                                                        <table class="ui-table ui-table-list" data-page-size="20" style="padding: 0px; text-align: center;">
                                                            ...
                                                            <tbody class="js-list-body-region" id="table-list-body">
                                                                ...
                                                                {pg: if (!empty($merInfo)) }
                                                                {pg: foreach item=v from=$merInfo }
                                                                ...
                                                                <tr class="widget-list-item">
                                                                    ...
                                                                    <td>{pg:$v.uname}</td>
                                                                    <td>
                                                                        {pg: if $v.sub_merchant==1 || $v.mtype==1 }
                                                                            {pg: if $v.isopenwxpay==1}
                                                                            <a href="/merchants.php?m=System&c=merchant&a=config&mid={pg:$v.mid}&type=1">
                                                                            ...
                                                                            {pg: if $v.isopenalipay==1}
                                                                            <a href="/merchants.php?m=System&c=merchant&a=config&mid={pg:$v.mid}&type=2">
                                                                        ...
                                                                        {pg: elseif $v.mtype == 3}
                                                                        金海哲
                                                                        {pg: elseif $v.sub_merchant == 1}
                                                                        子商户
                                                                        {pg:/if}

                                                                    </td>
                                                                    <td>
                                                                        <a class="btn btn-sm btn-info" href="/merchants.php?m=System&c=merchant&a=distribution&mid={pg:$v.mid}" style="vertical-align: top; background: #337ab7;"> 分配 </a>

                                                                        <a class="btn btn-sm btn-info" href="/merchants.php?m=User&c=index&a=index&m_mid={pg:$v.mid}" style="vertical-align: top; background: #36a9e0;" target="_blank">一键登录 </a>

                                                                        <button class="btn btn-sm btn-danger delete" data-id="{pg:$v.mid}"><strong>删&nbsp;&nbsp;除 </strong></button>
