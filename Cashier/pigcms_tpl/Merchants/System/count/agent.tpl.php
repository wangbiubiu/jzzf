...
<!--                                             <th>佣金率</th> -->
                                        ...
                                        {pg: foreach item=row from=$agents }
                                        <tr>
                                            <td>{pg:$row.uname}</td>
                                            <td>
                                                <p>微信</p>
...
<!--                                            <td> -->
<!--                                                 <p>{pg:$row.commission*100}%</p> -->
<!--                                                 <p>{pg:$row.commission*100}%</p> -->
<!--                                                 <p>{pg:$row.commission*100}%</p> -->
<!--                                             </td> -->
                                            <td>
                                                <p>{pg:$row.wxincome}</p>
                                                <p>{pg:$row.aliincome}</p>
                                                <p>{pg:$row.qqincome}</p>
                                            </td>

                                            <td><a href="/merchants.php?m=System&c=count&a=agentdetail&aid={pg:$row.aid}"><button>查看</button></a></td>
                                        </tr>
                                       {pg:/foreach} 
                                ...
                                <div class="hz clearfix">                                  
                                    <p>总收入：{pg: $data.income}元</p>
                                    <p>总金额：{pg: $data.sum}元</p>
                                    <p>总笔数：{pg: $data.count}笔</p>
                                </div>
