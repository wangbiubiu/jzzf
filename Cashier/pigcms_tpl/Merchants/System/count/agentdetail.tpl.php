                            ...
                            <div class="ibox float-e-margins">
                                <div class="ibox-title">
                                    <div class="form-group" style="border-bottom: 1px solid #cccccc; font-size: 18px;">
                                        <label class="font-noraml">{pg:$name.uname}的流水统计</label>
                                    ...
                                    <div class="clearfix" style="height:240px; position: relative;">
                                        <table border="1" class="payment" style="margin: 30px 30px 30px 0px; " width="60%" bordercolor="#e0e0e0">
                                            <tbody>
                                                ...
                                                {pg: if $getdata.type=="weixin"} 
                                                <tr>
                                                    <td>微信支付</td>
                                                    <td>{pg:$wxsum}</td>
                                                    <td>{pg:$wxincome_sum}</td>
                                                </tr>
                                                {pg: elseif $getdata.type=='alipay'}
                                                <tr>
                                                    <td>支付宝</td>
                                                    <td>{pg:$alisum}</td>
                                                    <td>{pg:$alicome_sum}</td>
                                                </tr>
                                                {pg: elseif $getdata.type=='qq'}
                                                <tr>
                                                    <td>qq</td>
                                                    <td>{pg:$qqsum}</td>
                                                    <td>{pg:$qqcome_sum}</td>
                                                ...
                                                {pg: else }
                                                    <tr>
                                                        <td>{pg: if $getdata.start && $getdata.end}{pg:$getdata.start }至{pg:$getdata.end}{pg: elseif $getdata.start}{pg:$getdata.start}起{pg:elseif $getdata.end}{pg:$getdata.end}止{pg:else}全部{pg:/if}</td>
                                                        <td>{pg:$total_sum}</td>
                                                        <td>{pg:$totalincome_sum}</td>
                                                    </tr>
                                                    <tr>
                                                        <td>微信支付</td>
                                                        <td>{pg:$wxsum}</td>
                                    ...
                                    <div class="clearfix">
                                        <table border="1" class="payment1" style="margin: 60px 30px 30px 0px;" width="100%" bordercolor="#e0e0e0">
                                            <tbody>
                                                ...
                                                {pg: foreach item=row from=$order}
                                                        <tr>
                                                            <td>{pg:$row.order_id}</td>
                                                            <td>{pg:$row.goods_price}</td>
                                                            ...
                                                            <td>{pg:$row.company}+{pg:$row.business_name} {pg:$row.branch_name} </td>
                                                            {pg: if  $row.refund ==2}
                                                            <td><button class="btn btn-sm" style="background: #CCC;color: #FFF;">已退款</button></td>

                                                            {pg: else }
                                                            <td><button class="btn btn-sm" style="background: #008000;color: #FFF;" onclick="{pg:if $row.pay_way == 'weixin'}wx{pg: elseif $row.pay_way=='alipay'}ali{pg:/if}RefundBtn(this,{pg: $row.id},{pg: $row.mid});"><strong> 退&nbsp;&nbsp;&nbsp;款 </strong></button> </td>
                                                            {pg:/if}
                                                        </tr>
...
<script src="{pg:$smarty.const.PIGCMS_TPL_STATIC_PATH}cashier/commonfunc.js"></script>
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var doughnutData_m = [
            {
                value: {pg: if $getdata.type=='alipay'}{pg: 0 }{pg: else }{pg:$wxsum}{pg: /if},
                color: "#33EA90",
            highlight: "#4BFFA8",
                label: "微信支付"
            },
            {
                value: {pg: if $getdata.type=='weixin'}{pg: 0 }{pg: else }{pg:$alisum}{pg: /if},
                color: "#00a3d2",
            highlight: "#24c7f6",
                label: "支付宝"
            },
