                            ...
                            <div class="ibox float-e-margins">
                                <div class="ibox-title">
                                    <div class="form-group" style="border-bottom: 1px solid #cccccc; font-size: 18px;">
                                        <label class="font-noraml">{pg:$name.company}的流水统计</label>
                                            ...
                                            <tbody>
                                                ...
                                                {pg: else}
                                                    <tr>
                                                        ...
                                                        <td>{pg:if !empty($total_sum.0.money)}{pg:$total_sum.0.money}{pg:else}0{pg:/if}</td>
                                                        <td>{pg:if !empty($total_sum.0.income)}{pg:$total_sum.0.income}{pg:else}0{pg:/if}</td>
                                                    </tr>
                                                    <tr>
                                                        <td>微信支付</td>
                                                        <td>{pg:if !empty($wxsum.0.money)}{pg:$wxsum.0.money}{pg:else}0{pg:/if} </td>
