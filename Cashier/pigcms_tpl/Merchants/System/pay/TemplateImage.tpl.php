        			...
        			<div class="clearfix">
							<label style="float: left;"><i>*</i>支付二维码模版：</label>
									   ...
									   <div class="img_upload_wrp group"> 
											...
											<div class="js_pager">
											     <div class="img_upload_box img_upload_preview_box js_edit_pic_wrp yjf1">
											         <img style="width:400px; height:600px"   src="{pg:$pay_img_url}">
								...
								<div style="float: right; margin-right:20px; width:300px;">
								    ...
								    <img style="width:100%" alt="" src="{pg:$url}/Cashier/upload/img/pay_test.jpg"  >
								</div>
					</div>		
					<div class="clearfix">
									   ...
									   <div class="img_upload_wrp group"> 
											...
											<div class="js_pager">
											     <div class="img_upload_box img_upload_preview_box js_edit_pic_wrp yjf2">
											         <img style="width:400px; height:200px"  src="{pg:$notice_img_url}">
											             <input name="photo_list[]" class="imginput" type="hidden" value="'+rept.wxlogurl+'">
							...
							<div style="float: right; margin-right:20px;width:300px;">
								    ...
								    <img alt="" src="{pg:$url}/Cashier/upload/img/notice_test.jpg" style="width:100%;">
							</div>
					</div>
        		</form>
