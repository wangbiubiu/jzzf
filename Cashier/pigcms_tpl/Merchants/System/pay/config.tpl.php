				...
				<div class="modal-body">
					<div class="setting_rows">
						<div id="new_wxpay_box" class="wxpay_box">
							...
							<div class="form-group">
								<label>服务商商户号</label>
								<input type="text" placeholder="服务商商户号" value="{pg:$payConfig.weixin.mchid}" name="weixin[mchid]" class="form-control">
							</div>
                                                        <div class="form-group">
								<label>二清商户号</label>
								<input type="text" placeholder="二清商户号" value="{pg:$payConfig.weixin.sub_mch_id_two}" name="weixin[sub_mch_id_two]" class="form-control">
							</div>
							<div class="form-group">
								<label>特约子商户号(多个子商户号用英文逗号分隔)</label>
<!--								<input type="text" placeholder="如：1265536601,1265538835" class="form-control">-->
								<textarea name="weixin[sub_mchid]" placeholder="如：1265536601,1265538835"  class="form-control" rows="3">{pg:$payConfig.weixin.sub_mchid|urldecode}</textarea>
				...
				<div class="modal-body">
					<div class="setting_rows">
						<div id="new_wxpay_box" class="wxpay_box">
                            ...
                            <div class="form-group">
                                <label>二清商户号</label>
                                <input type="text" placeholder="二清商户号" value="{pg:$payConfig.alipay.sub_mch_id_two}" name="alipay[sub_mch_id_two]" class="form-control">
                            </div>
							<div class="form-group">
								<label>卖家账号</label>
