					...
					<div class="col-lg-12">
						<div class="ibox float-e-margins">
							<div class="ibox-title clearfix">
								<ul class="nav">
									<li>
										<button class="btn btn-primary" id="pop_add_card"><i class="fa fa-plus"></i> 创建新会员卡</button>
									</li>
								</ul>
							</div>
														...
														<tbody class="js-list-body-region" id="table-list-body">
															...
															<tr class="widget-list-item">
																...
																<td class="footable-visible footable-last-column">
																	...
																	<a class="btn btn-sm btn-info" href="?m=User&c=wxCoupon&a=cardactive&id=<?php echo $ovv['id'];?>" style="vertical-align: top;"> 设置填写资料 </a> 
																	<?php }?>
																	<a class="btn btn-sm btn-info" href="?m=User&c=wxCoupon&a=wxCardList&id=<?php echo $ovv['id'];?>" style="vertical-align: top;"> 会员信息 </a>
