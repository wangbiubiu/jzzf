            ...
            <div class="row wrapper border-bottom white-bg page-heading">
				<div class="col-lg-10">
					...
					<ol class="breadcrumb">
						<li><a>User</a></li>
						<li><a>wxCoupon</a></li>
						<li class="active"><strong>paycell</strong></li>
					</ol>
				</div>
													...
													<table class="ui-table ui-table-list" data-page-size="20" style="padding: 0px;">
														<thead class="js-list-header-region tableFloatingHeaderOriginal">
															<tr class="widget-list-header">
																<th>编号</th>
																<th data-hide="phone">消费的门店</th>
																<th data-hide="phone">订单号</th>
																<th data-hide="phone">实付金额</th>
																<th data-hide="phone">应付金额</th>
																<th data-hide="phone">支付时间</th>
															</tr>
														</thead>
														<tbody class="js-list-body-region" id="table-list-body">
															<?php
															if (!empty ($paycell_list)) {
																foreach ($paycell_list as $ovv) {
															?>
           													<tr class="widget-list-item">
																<td><?php echo $ovv['id'];?></td>
																<td><?php echo $ovv['location_name'];?></td>
																<td><?php echo $ovv['orderid'];?></td>
																<td><?php echo $ovv['fee'];?></td>
																<td><?php echo $ovv['original_fee'];?></td>
