                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content" style="border-top:none;">
                            ...
                            <div class="panel-body" style="padding: 0px; ">
                                <form enctype="multipart/form-data" action="merchants.php?m=Agent&c=adManage&a=addAd" method="post" class="form-horizontal form-border jbxi_bg clearfix"
                                        ...
                                        <div>
                                            <select name="shanghu" value='' id="mtype" style="margin-top: 5px;">
                                                ...
                                                <?php } else{ ?>
                                                    ...
                                                    <?php foreach ($shanghu as $key => $c): ?>
                                                        <option value="<?php echo $c['mid'] ?>"><?php echo $c['company'] ?></option>
                                                    <?php endforeach ?>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group clearfix">
                                        ...
                                        <div>
                                            <select name="provinceid" id="provinceS"
                                                    style="width:126px;float: left;height: 30px"
                                                    onchange="GetCity();">
                                                <option value="0">全国</option>
                                                <?php foreach ($districts as $key => $a): ?>
                                                    <option value="<?php echo $a['id'] ?>"
                                                            data-fullname="<?php echo $a['fullname']; ?>"
                                                            data-lng="<?php echo $a['lng']; ?>"
                                                            data-lat="<?php echo $a['lat']; ?>" <?php if($result[0]['ad_shenaddress']==$a['fullname']) echo'selected'; ?>><?php echo $a['fullname']; ?></option>
                                                <?php endforeach ?>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group clearfix">
                                        ...
                                        <div>
                                            <input name="startTime" size="16" type="time" id="startTime" value="<?php echo $result[0]['ad_tfstarttime'] ?>" class="form_time form-control" placeholder="请选择开始投放时间" style="width: 200px;">
                                            <label>至</label>
                                            <input name="endTime" size="16" type="time" id="endTime" value="<?php echo $result[0]['ad_tfendtime'] ?>" class="form_time form-control" placeholder="请选择结束投放时间" style="width: 200px;">
                                        </div>
                                    </div>
                                    <div class="form-group clearfix">
                                        <label class=" control-label"><i>*</i>有效时间段</label>
                                        <div>
                                            <input name="startTime1" size="16" id="startTime1" value="<?php echo $result[0]['ad_sxstarttime'] ?>" type="text" readonly class="form_datetime form-control" placeholder="请选择开始投放时间" style="width: 200px;">
                                            <label>至</label>
                                            <input name="endTime1" size="16" id="endTime1" value="<?php echo $result[0]['ad_sxendtime'] ?>" type="text" readonly class="form_datetime form-control" placeholder="请选择结束投放时间" style="width: 200px;">
                                        </div>
                                    ...
                                    <div class="form-group clearfix">
                                        ...
                                        <div>
                                            ...
                                            <input name="link1" type="text" placeholder="请输入支付页面广告图片链接" style="border:1px solid #ccc; height: 30px; width: 300px;">

                                        </div>
                                    </div>
                                    <div class="form-group clearfix">
                                        <label class=" control-label"><i>*</i>支付成功后广告链接</label>
                                        <div>
<!--                                            <a id="dropzone1">选择图片</a>-->
<!--                                            <input name="file2" type="hidden" id="file2">-->
                                            <input name="link2" type="text" placeholder="请输入支付成功后跳转链接" style="border:1px solid #ccc; height: 30px; width: 300px;">
                                        </div>
                                    </div>
                                    <div id="errmsg"></div>
                                    ...
                                    <input id="adid" type="hidden" value="<?php echo $result[0]['ad_id'] ?>">
