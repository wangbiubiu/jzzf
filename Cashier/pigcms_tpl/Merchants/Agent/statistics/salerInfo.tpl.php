					...
					<div class="col-lg-12">
						<div class="ibox float-e-margins">
							<div class="ibox-title">
								<div class="form-group" style="border-bottom: 1px solid #cccccc; font-size: 18px;">
									<label class="font-noraml">业务员数据</label>
								...
								<!--
                                	...
                                	描述：选择日期
                                -->
                        <form action="?m=Agent&c=statistics&a=salerInfo" method="get">
                       
                        <input type="hidden" name="m" value="Agent">
                        <input type="hidden" name="c" value="statistics">
                        <input type="hidden" name="a" value="salerInfo">
						...
						<div id="dataselect" class="form-group" style="padding: 0 10px;">
							<div id="datepicker" class="input-daterange">
								...
								&nbsp;&nbsp;&nbsp;<input class="btn btn-primary" type="submit" value="查 询" style="width:70px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="btn btn-primary"  style="width:100px;" href="?m=Agent&c=statistics&a=info2Excel&sid=<?php echo $getdata['id']; ?>">导出excel</a>
							</div>
						</div>
						</form>		<!--
                                	作者：2721190987@qq.com
                                ...
                                <div class="clearfix" style=" position: relative; height: 240px">
                                	<table border="1" class="payment" style="margin: 30px 30px 30px 0px;" width="60%" bordercolor="#e0e0e0">
                                		<tbody>
                                			...
                                			<tr>
                                				<td> <?php if (isset($getdata['start'])){echo $getdata['start'];} ?> 至 <?php if(isset($getdata['end'])){echo $getdata['end'];}else{echo '今天';} ?></td>
                                				<td><?php echo $sum; ?></td>
                                	...
                                	<table border="1" class="payment1" style="margin: 30px 30px 30px 0px;" width="100%" bordercolor="#e0e0e0">
                                		<tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                <?php echo $ov['business_name']; ?><?php echo $ov['branch_name']; ?></td>
                                                <td>
