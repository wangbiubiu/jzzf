...
<html>
<head>
<title>代理商|数据统计</title>
    <?php include RL_PIGCMS_TPL_PATH.APP_NAME.'/'.ROUTE_MODEL.'/public/header.tpl.php';?>
	<link
	href="<?php echo $this->RlStaticResource;?>plugins/css/datapicker/datepicker3.css" rel="stylesheet">
<script
	src="<?php echo $this->RlStaticResource;?>plugins/js/chartJs/Chart.min.js"></script>
<!-- Data picker -->
...
<body>
	...
	function GetChartData(typ,idstr,idstr2){
		if(typ=='date'){
		  ...
		  var store_id = parseInt($('#store_date').val());
		  var pdatas={
		        'typ': typ,
			    'dstart':start,
			    'dend':end,
		  ...
		  var store_id = parseInt($('#store_mouth').val());
		  var pdatas={
		        'typ': typ,
			    'dstart':start,
			    'dend':end,
