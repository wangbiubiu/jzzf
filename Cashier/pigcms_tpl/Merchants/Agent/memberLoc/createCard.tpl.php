                        ...
                        <div class="ibox-content">
                            ...
                            <form method="POST" action="/merchants.php?m=User&c=memberLoc&a=createCarding" id="createCardform" class="form-horizontal">	
								...
								<div class="form-group">
									...
									<input type="text" name="vipnamecolor" id="vipnamecolor" value="<?php echo $cardinfo['vipnamecolor'];?>" class="form-control color" style="width: 90px; background:; color: rgb(255, 255, 255);" onblur="changeCardColor('vipnamecolor','vipname')">
									</div>
                                </div>
								...
								<div class="form-group">
									...
									<input type="text" name="numbercolor" id="numbercolor" value="<?php echo $cardinfo['numbercolor'];?>" class="form-control color" style="width: 90px; background:; color: rgb(255, 255, 255);" onblur="changeCardColor('numbercolor','number')" >
									</div>
