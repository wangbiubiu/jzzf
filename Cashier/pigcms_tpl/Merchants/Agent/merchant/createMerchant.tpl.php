                          ...
                          <div class="panel-body" style="padding: 0px; ">
                                <form class="form-horizontal form-border jbxi_bg clearfix" style="width: 95%; margin: 0 auto 60px; position: relative; border: 1px solid #EEEEEE;" action="?m=Agent&c=merchant&a=createMerchant" method="post">
                                     <div class="form-group clearfix">
                                        ...
                                        <div>
                                            <select name="mtype" value='' id="mtype" style="margin-top: 5px;">
                                                <option value=''>请选择商户类型</option>
                                                <option value='1'>特约商户</option>
                                                <option value='2'>银行直连</option>
                                                <option value='3'>金海哲（支付）</option>
<!--                                                <option value='3'>加盟商模式</option>-->
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group clearfix">
                                        ...
                                        <div>
                                            <input type="text" class="form-control" placeholder="请输入公司全称" name='company'>
                                        </div>
                                    </div>
                                    <div class="form-group clearfix">
                                        <label class=" control-label"><i>*</i>登录账号</label>
                                        <div>
                                            <input type="text" class="form-control" placeholder="建议使用邮箱账号" name='username'>
                                        </div>
                                    </div>
                                    <div class="form-group clearfix">
                                            <label><i>*</i>新密码</label><input type="password" placeholder="输入新密码" style="border: none;" name='password'><br /><br />
                                            <label><i>*</i>新密码</label><input type="password" placeholder="确认新密码" style="border: none;" name="password2">
                                    ...
                                    <div class="form-group clearfix rebateAclear" style="display:none">
                                        ...
                                        <!--
                                        <div>
                                           <input type="text"   name="commission"  class="form-control" value='<?php echo $merchant['commission']; ?>' />
                                        </div>
                                        -->
                                    </div>
                                    <div class="form-group clearfix rebateAclear" style="display:none">
                                        ...
                                        <!--
                                        <div>
                                           <input type="text"   name="alicommission"  class="form-control" value='<?php echo $merchant['alicommission']; ?>' />
                                        </div>
                                        -->
                                    </div>
                                    ...
                                    <div class="form-group clearfix rebatejhzwx" style="display:none">
                                        <label class=" control-label"><i>*</i>微信费率</label>
                                        <select name="commission_jhzwx">
                                            <?php foreach ($cashier_wxrebate_jhzwx as $v){?>
                                    ...
                                    <div class="form-group clearfix rebatejhzqq" style="display:none">
                                        <label class=" control-label"><i>*</i>财付通费率</label>
                                        <select name="commission_jhzqq">
                                            <?php foreach ($cashier_wxrebate_jhzqq as $v){?>
                                    ...
                                    <div class="form-group clearfix">
                                        ...
                                        <div>
                                           <input type="text" class="form-control" placeholder="联系人" name='realname'>
                                        </div>
                                    </div>
                                    <div class="form-group clearfix">
                                        <label class=" control-label"><i>*</i>联系电话</label>
                                        <div>
                                            <label><input type="text"  placeholder="" onkeyup="this.value=this.value.replace(/\D/g,'')" name="phone"></label>
                                ...
                                <!-- 3级联动 -->
                                  ...
                                  <!-- 3级联动 -->
                                    ...
                                    <div class="form-group clearfix" style="display:none" id="subMerch">
        ...
        !function(win, $){
            $('#mtype').change(function(){
                if($(this).val() ==1){
                    ...
                    $('.rebatejhzwx').css('display','none');
                	$('.rebatejhzqq').css('display','none');
                    ...
                    {
                        $('.rebatejhzqq').css('display','block');
                        $('.rebatejhzwx').css('display','block');
                    	$(".rebateAn").css('display','none');
                        $(".rebateAclear").css('display','none');
                        $('#subMerch').css('display','block');
                    }
