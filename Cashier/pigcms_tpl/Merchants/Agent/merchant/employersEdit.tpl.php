...
<body>
    ...
    <div id="wrapper">
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
				<form id="employersForm" class="form" action="?m=Agent&c=merchant&a=employersAppemd" method="post">
                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-content">
							...
							<div class="form-group">
								...
								<input type="tel" id="phone" placeholder="请输入员工的手机号" name="phone" value="<?php echo $employee['phone'];?>" class="form-control required" aria-required="true">
							</div>
							<div class="form-group">
								...
								<?php }else{?>
								 <select name="storeid" class="form-control" style="z-index:999">
								  ...
								  <?php foreach($StoreInfo as $svv){?>
								   <option  value="<?php echo $svv['id'];?>" <?php if($svv['id']==$employee['storeid']) echo 'selected="selected"';?>><?php echo $svv['business_name'].$svv['branch_name']?></option>
								  <?php }?>
								 </select>
