...
-->                 
					...
					<div class="select_permissions ">
					   <?php if($reg['status'] == '3' || $reg['status'] == '4'){?>
					       <h2>商户信息<a style="float: right; padding-right: 10px;" href="?m=Agent&c=merchant&a=regMerchantInfo&type=2&mid=<?php echo $_GET['mid'];?>">修改</a></h2>
					   <?php }else{?>
					       <h2>商户信息</h2>
					   <?php }?>
					...
					<div class="select_permissions ">
					   <?php if($reg['status'] == '3' || $reg['status'] == '4'){?>
   					       <h2>结算信息<a style="float: right; padding-right: 10px;" href="?m=Agent&c=merchant&a=examine&type=3&mid=<?php echo $_GET['mid'];?>">修改</a></h2>
					   <?php }else{?>
					       <h2>结算信息</h2>
					   <?php }?>  
					...
					<?php if($reg['status'] == '3' || $reg['status'] == '4'){?>
    					<p class="tj" style="margin: 0 auto;width: 100px;">
    						 <a  href="?m=Agent&c=merchant&a=again&mid=<?php echo $_GET['mid'];?>">
