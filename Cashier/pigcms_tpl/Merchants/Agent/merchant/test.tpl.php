            ...
            <div class="row wrapper border-bottom white-bg page-heading">
				<div class="col-lg-10">
					...
					<ol class="breadcrumb">
						<li><a>User</a></li>
						<li><a>merchant</a></li>
						<li class="active"><strong>车市文件</strong></li>
					</ol>
				</div>
									...
									<div>
										...
										<div class="cashier-realtime">
											<div class="realtime-title-block clearfix">
												<h1 class="realtime-title">门店列表</h1>
											</div>
										</div>
													...
													<table class="ui-table ui-table-list" data-page-size="20" style="padding: 0px;">
														...
														<tbody class="js-list-body-region" id="table-list-body">
															...
															<tr class="widget-list-item">
																...
																<td>
																	<a class="btn btn-sm btn-info" href="?m=User&c=merchant&a=storedetail&id=<?php echo $ovv['id'];?>" style="vertical-align: top;"> 门店详情 </a>
