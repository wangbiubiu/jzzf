            ...
            <div class="one-half-responsive" style="min-height:900px;">
                <div class="container no-bottom">
                    <div class="contact-form no-bottom">
                        ...
                        <form action="?m=Index&c=pay&a=pay" method="post" class="contactForm" id="contactForm" name="contactForm">
                            <fieldset>
                                ...
                                <div class="formFieldWrap">
                                    <input type="hidden" name="auth_code" class="contactField requiredField" id="days_numberField" value=""/>
                                </div>
                                <div class="formFieldWrap" style="margin-top:10px;">
                                    <a class="buttonWrap button button-green contactSubmitButton"  id="qrcode_btn"/>扫一扫支付</a>
                                </div>
