...
<html lang="zh-CN">
	<head>
		...
		<script language="javascript">
			var param =<?php echo json_encode($weixin_param);?>;
			function callpay(){
				WeixinJSBridge.invoke("getBrandWCPayRequest",param,function(res){
					...
					if(res.err_msg=="get_brand_wcpay_request:ok"){
						...
						if(link2 !== ""){
                            ...
                            window.location.href = "<?php echo $redirctUrl;?>"
                        }
	...
	<body style="padding-top:20px;">
			...
			<ul class="round">
				...
				<li class="nob">
					<table width="100%" border="0" cellspacing="0" cellpadding="0" class="kuang">
						<tr><th>金额</th><td><?php echo $pay_money;?>元</td></tr>
					</table>
				</li>
			</ul>
			<div class="footReturn" style="text-align:center">
				<input type="button" style="margin:0 auto 20px auto;width:100%"  onclick="callpay()"  class="submitbtn" value="点击进行微信支付" />
        ...
        <?php if($adresult['img1']!=""){ ?>
            <center><a href="<?php echo $adresult['link1'] ?>" target="_blank"><img src="<?php echo $adresult['img1'] ?>" width="90%"></a></center>
        <?php } ?>
