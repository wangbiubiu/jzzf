            ...
            <form class="m-t" role="form" id="form" method="post" action="?m=Index&c=login&a=signin">
				...
				<div class="form-group">
                    <div class="radio radio-info radio-inline">
						<input type="radio" value="merchant" name="type" id="inlineRadio1">
						<label for="inlineRadio1"> 商户登录</label>
					</div>
					<div class="radio radio-inline">
                        <input type="radio" value="employee" name="type" checked="checked" id="inlineRadio2">
                        <label for="inlineRadio2"> 门店登录</label>
                    </div>
                </div>
...
<!--                
			  ...
			  <p class="m-t"> <small style="color: #FFFFFF;">重庆云极付科技有限公司版权所有渝ICP备13007293号渝ICP备13015917号 @2011-2016</small> </p>
        </div>
    </div>
</div>
    <!-- Mainly scripts -->
